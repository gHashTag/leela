...
type navigation = NativeStackNavigationProp<RootStackParamList, 'SETTINGS_SCENE'>

export const SettingsScene = memo(({ navigation }: { navigation: navigation }) => {
    ...
    },
    {
      ...
      rows: [
        ...
        },
        {
          ...
          icon: '🧭',
          onPress: () => navigation.navigate('MAIN', { screen: 'TAB_BOTTOM_3' }),
            ...
            <View style={styles.card}>
              {section.rows.map((row, index) => (
                <View key={row.key}>
                  ...
                  {row.key !== 'haptics' && row.key !== 'reducedMotion' && row.key !== 'theme' && row.key !== 'accessibility' && (
                    <SettingsRow {...row} />
                  )}
