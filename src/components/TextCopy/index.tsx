      ...
      <TextInput
        style={[
          ...
          h0 &&
            StyleSheet.flatten([
              h0Style,
              { color: text, textShadowColor: color ? color : primary }
            ]),
          h1 &&
            StyleSheet.flatten([
              h1Style,
              { color: text, textShadowColor: color ? color : primary, textAlign }
            ]),
          h2 &&
            StyleSheet.flatten([
              h2Style,
          ...
          h8 &&
            StyleSheet.flatten([
              h8Style,
              { color: secondary, textShadowColor: color ? color : primary, textAlign }
            ]),
