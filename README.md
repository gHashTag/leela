...
| Package | Tests | State |
|---|---|---|
| `@leela/engine` | 358 | rules, four variants, sessions, turn gating, seeded dice |
| `@leela/content` | 332 | 22 languages of plans, 2 of the game's own voice |
| `@leela/journal` | 72 | the path as a file, and what came back — shared by the bot and the mini app |
| `@leela/db` | 105 | schema, mapping, SQL migrations, legacy import |
| `@leela/ai` | 191 | the companion — prompts built from the plan text |
| `@leela/contracts` | 62 | `LeelaGame.sol`, board verified against the engine — [readme](packages/contracts/README.md) |
| `@leela/bot` | 602 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
| `@leela/docs` | 219 | the book, live at [t27.ai/leela/docs](https://t27.ai/leela/docs/) — [readme](apps/docs/README.md) |
| `@leela/miniapp` | 468 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| `@leela/mobile` | 340 | the board on a phone (Expo), moved by the engine and by nothing else |
| everything else | — | not yet ported |

2749 tests, run on every push by [CI](.github/workflows/ci.yml), which also
