...
| `@leela/bot` | 621 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
| `@leela/mobile` | 382 | the board on a phone (Expo), moved by the engine and by nothing else |
| everything else | — | not yet ported |

2990 tests, run on every push by [CI](.github/workflows/ci.yml), which also
