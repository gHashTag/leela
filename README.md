...
| `@leela/journal` | 51 | the path as a file, and what came back — shared by the bot and the mini app |
...
| `@leela/bot` | 503 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
| `@leela/docs` | 114 | the book, live at [t27.ai/leela/docs](https://t27.ai/leela/docs/) — [readme](apps/docs/README.md) |
| `@leela/miniapp` | 368 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| everything else | — | not yet ported |

1863 tests, run on every push by [CI](.github/workflows/ci.yml), which also
