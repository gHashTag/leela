...
| `@leela/bot` | 952 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
| `@leela/docs` | 239 | the book, live at [t27.ai/leela/docs](https://t27.ai/leela/docs/) — [readme](apps/docs/README.md) |
| `@leela/miniapp` | 608 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| `@leela/mobile` | 408 | the board on a phone (Expo), moved by the engine and by nothing else |
| `@leela/webgl` | 561 | the board in three dimensions, in a browser, on the same rules the apps play |
| everything else | — | not yet ported |

4600 tests, run on every push by [CI](.github/workflows/ci.yml), which also
