...
| `@leela/ai` | 242 | the companion — prompts built from the plan text |
| `@leela/contracts` | 95 | `LeelaGame.sol`, board verified against the engine — [readme](packages/contracts/README.md) |
| `@leela/bot` | 1025 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
4867 tests, run on every push by [CI](.github/workflows/ci.yml), which also
