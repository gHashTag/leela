...
| `@leela/bot` | 1029 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
| `@leela/webgl` | 599 | the board in three dimensions, in a browser, on the same rules the apps play |
| everything else | — | not yet ported |

4875 tests, run on every push by [CI](.github/workflows/ci.yml), which also
