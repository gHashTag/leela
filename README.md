...
| `@leela/bot` | 1170 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
5043 tests, run on every push by [CI](.github/workflows/ci.yml), which also
