...
| `@leela/bot` | 1166 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
5039 tests, run on every push by [CI](.github/workflows/ci.yml), which also
