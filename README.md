...
| `@leela/webgl` | 623 | the board in three dimensions, in a browser, on the same rules the apps play |
| everything else | — | not yet ported |

5127 tests, run on every push by [CI](.github/workflows/ci.yml), which also
