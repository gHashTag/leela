...
| Package | Tests | State |
|---|---|---|
| `@leela/engine` | 345 | rules, four variants, sessions, turn gating, seeded dice |
...
| `@leela/bot` | 583 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
2642 tests, run on every push by [CI](.github/workflows/ci.yml), which also
