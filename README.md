...
| Package | Tests | State |
|---|---|---|
| `@leela/engine` | 290 | rules, four variants, sessions, turn gating, seeded dice |
| `@leela/content` | 164 | 22 languages of plans, 2 of the game's own voice |
...
| `@leela/ai` | 134 | the companion — prompts built from the plan text |
| `@leela/contracts` | 37 | `LeelaGame.sol`, board verified against the engine — [readme](packages/contracts/README.md) |
| `@leela/bot` | 315 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
| `@leela/docs` | 112 | the book, live at [t27.ai/leela/docs](https://t27.ai/leela/docs/) — [readme](apps/docs/README.md) |
| `@leela/miniapp` | 165 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| everything else | — | not yet ported |

1337 tests, run on every push by [CI](.github/workflows/ci.yml), which also
