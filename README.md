...
| `@leela/journal` | 31 | the path as a file, and what came back — shared by the bot and the mini app |
...
| `@leela/miniapp` | 254 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| everything else | — | not yet ported |

1563 tests, run on every push by [CI](.github/workflows/ci.yml), which also
