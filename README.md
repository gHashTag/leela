...
| `@leela/bot` | 1197 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
5070 tests, run on every push by [CI](.github/workflows/ci.yml), which also
