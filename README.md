...
| `@leela/content` | 713 | 22 languages of plans, 2 of the game's own voice |
...
| `@leela/ai` | 246 | the companion — prompts built from the plan text |
| `@leela/contracts` | 95 | `LeelaGame.sol`, board verified against the engine — [readme](packages/contracts/README.md) |
| `@leela/bot` | 1043 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
4903 tests, run on every push by [CI](.github/workflows/ci.yml), which also
