...
| `@leela/content` | 718 | 22 languages of plans, 2 of the game's own voice |
...
| `@leela/bot` | 1234 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
5248 tests, run on every push by [CI](.github/workflows/ci.yml), which also
