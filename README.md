...
| `@leela/bot` | 1175 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
5048 tests, run on every push by [CI](.github/workflows/ci.yml), which also
