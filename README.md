...
| Package | Tests | State |
|---|---|---|
| `@leela/engine` | 366 | rules, four variants, sessions, turn gating, seeded dice |
...
| `@leela/docs` | 225 | the book, live at [t27.ai/leela/docs](https://t27.ai/leela/docs/) — [readme](apps/docs/README.md) |
| `@leela/miniapp` | 476 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| `@leela/mobile` | 351 | the board on a phone (Expo), moved by the engine and by nothing else |
| everything else | — | not yet ported |

2782 tests, run on every push by [CI](.github/workflows/ci.yml), which also
