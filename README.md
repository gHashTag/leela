...
| `@leela/miniapp` | 651 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
...
4682 tests, run on every push by [CI](.github/workflows/ci.yml), which also
