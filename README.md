...
| Package | Tests | State |
|---|---|---|
| `@leela/engine` | 311 | rules, four variants, sessions, turn gating, seeded dice |
...
| `@leela/bot` | 354 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
1423 tests, run on every push by [CI](.github/workflows/ci.yml), which also
