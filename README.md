...
| Package | Tests | State |
|---|---|---|
| `@leela/engine` | 318 | rules, four variants, sessions, turn gating, seeded dice |
...
| `@leela/bot` | 385 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
| `@leela/docs` | 114 | the book, live at [t27.ai/leela/docs](https://t27.ai/leela/docs/) — [readme](apps/docs/README.md) |
| `@leela/miniapp` | 218 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| everything else | — | not yet ported |

1509 tests, run on every push by [CI](.github/workflows/ci.yml), which also
