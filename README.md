...
| `@leela/journal` | 83 | the path as a file, and what came back — shared by the bot and the mini app |
...
| `@leela/bot` | 617 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
| `@leela/docs` | 239 | the book, live at [t27.ai/leela/docs](https://t27.ai/leela/docs/) — [readme](apps/docs/README.md) |
| `@leela/miniapp` | 494 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| `@leela/mobile` | 378 | the board on a phone (Expo), moved by the engine and by nothing else |
| everything else | — | not yet ported |

2977 tests, run on every push by [CI](.github/workflows/ci.yml), which also
