...
| Package | Tests | State |
|---|---|---|
| `@leela/engine` | 382 | rules, four variants, sessions, turn gating, seeded dice |
...
| `@leela/bot` | 608 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
2823 tests, run on every push by [CI](.github/workflows/ci.yml), which also
