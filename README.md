...
| `@leela/content` | 349 | 22 languages of plans, 2 of the game's own voice |
...
| `@leela/docs` | 230 | the book, live at [t27.ai/leela/docs](https://t27.ai/leela/docs/) — [readme](apps/docs/README.md) |
...
2845 tests, run on every push by [CI](.github/workflows/ci.yml), which also
