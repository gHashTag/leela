...
| `@leela/bot` | 590 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
| `@leela/docs` | 213 | the book, live at [t27.ai/leela/docs](https://t27.ai/leela/docs/) — [readme](apps/docs/README.md) |
| `@leela/miniapp` | 459 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| `@leela/mobile` | 340 | the board on a phone (Expo), moved by the engine and by nothing else |
| everything else | — | not yet ported |

2701 tests, run on every push by [CI](.github/workflows/ci.yml), which also
