...
| Package | Tests | State |
|---|---|---|
| `@leela/engine` | 324 | rules, four variants, sessions, turn gating, seeded dice |
...
| `@leela/ai` | 150 | the companion — prompts built from the plan text |
| `@leela/contracts` | 43 | `LeelaGame.sol`, board verified against the engine — [readme](packages/contracts/README.md) |
| `@leela/bot` | 434 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
| `@leela/docs` | 114 | the book, live at [t27.ai/leela/docs](https://t27.ai/leela/docs/) — [readme](apps/docs/README.md) |
| `@leela/miniapp` | 314 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| everything else | — | not yet ported |

1712 tests, run on every push by [CI](.github/workflows/ci.yml), which also
