...
| `@leela/miniapp` | 89 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| everything else | — | not yet ported |

1065 tests, run on every push by [CI](.github/workflows/ci.yml), which also
