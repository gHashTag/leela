...
| `@leela/content` | 282 | 22 languages of plans, 2 of the game's own voice |
...
| `@leela/ai` | 173 | the companion — prompts built from the plan text |
| `@leela/contracts` | 43 | `LeelaGame.sol`, board verified against the engine — [readme](packages/contracts/README.md) |
| `@leela/bot` | 547 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
| `@leela/docs` | 160 | the book, live at [t27.ai/leela/docs](https://t27.ai/leela/docs/) — [readme](apps/docs/README.md) |
| `@leela/miniapp` | 423 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| `@leela/mobile` | 277 | the board on a phone (Expo), moved by the engine and by nothing else |
| everything else | — | not yet ported |

2394 tests, run on every push by [CI](.github/workflows/ci.yml), which also
