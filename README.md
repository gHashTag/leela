...
| `@leela/bot` | 1094 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
4954 tests, run on every push by [CI](.github/workflows/ci.yml), which also
