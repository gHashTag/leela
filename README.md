...
| `@leela/miniapp` | 481 | the board as a mini app, live at [t27.ai/leela](https://t27.ai/leela/) — [readme](apps/miniapp/README.md) |
| `@leela/mobile` | 366 | the board on a phone (Expo), moved by the engine and by nothing else |
| everything else | — | not yet ported |

2892 tests, run on every push by [CI](.github/workflows/ci.yml), which also
