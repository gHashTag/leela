...
| `@leela/bot` | 1009 | group play in Telegram, durable on SQLite — [readme](apps/bot/README.md) |
...
4843 tests, run on every push by [CI](.github/workflows/ci.yml), which also
