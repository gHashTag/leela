const a=[{plan:1,title:"出生 (janma)",description:null,body:`出生是业力游戏的入口。因果报应是由骰子上滚动的点数决定的，而玩家的个性在场上通过一些符号来表示，这些符号根据其批次从一个方格移动到另一个方格。一个人在出生之前，就处于游戏之外。出生后，他就受到业力法则的约束。这个世界是业力之地。
...
单位是一切创造的根源。像所有奇数一样，它属于太阳家族。该单位与太阳有着特殊的关系，因为正是它孕育了我们的星球。该单位象征着一个独立的人、独立的决定、独立的生活、对新的、不寻常的、原创的事物的追求。`,source:"translate-leela/locales/zh/1-birth-zh.md"},{plan:2,title:"玛雅",description:null,body:`当一个人成为一名玩家时，团结感就在游戏的兴奋中消失了。这种意识的变化就是游戏行为的全部魅力所在。一人化作多人，与自己玩一场宇宙的捉迷藏游戏。为了满足他的自我，玩家在开始游戏时接受游戏规则，并遵循这些规则直到游戏结束。
...
二具有二元性的特质，即幻觉。当单元重复自身时获得该数字。二是一种幻觉，因为它的两个对立面都存在于一之中。这是内在和外在世界，未显化和显化，湿婆和萨克蒂，男性和女性原则，太阳和月亮，密集和微妙的世界，绝对和玛雅，本体和现象。所以二是玛雅人的数量。二是偶数，像所有偶数一样，是农历家族的一部分。她与月亮和月球能量有着特别密切的联系。`,source:"translate-leela/locales/zh/2-maya-zh.md"},{plan:3,title:"愤怒 (krodha)",description:null,body:`要了解愤怒的本质，必须了解自我的本质。自我就是将自己标识为“我”的东西。人在其发展过程中要经历一系列的认同。出生后，当孩子意识到自己与母亲的分离时，他首先开始感觉自己是一个独立的存在。然后是对其他家庭成员的认同，他将他们的行为和思维方式视为自己的。然后，孩子将自己与与他性别相同的同龄人联系起来。然后他在异性中寻找自己的身份。当自我最终将自己与绝对认同并与宇宙意识融合时，旅程就结束了。
...
三者体现了创造力、表现力和稳定性的品质。作为奇数家族的一员，她代表着活力和积极性，负责创造和维护形式。它与火元素有关，火元素在人身上以愤怒的形式表现出来。另一方面，同样的因素可以表现为勤奋、毅力。因此，数字3的特征是力量和决心。三是木星的数量。木星是勇气、勇敢、力量、力量、勤奋、能量、知识、智慧和灵性的象征。`,source:"translate-leela/locales/zh/3-anger-zh.md"},{plan:4,title:"贪婪（lobha）",description:null,body:`由于每个人出生时都会产生分离感，玩家开始寻求满足。为了在这个世界上执行任何功能，玩家必须首先确保满足自己的身体需求。要参加比赛，他必须吃饭、有休息的地方、有衣服。物质生存是第一脉轮级别玩家最关心的问题。
...
四的符号是一个代表四个维度和四个基点的正方形。数字四象征着土元素。作为偶数族的代表，四趋于完备。对物质层面完美的渴望达到极限，就会变成贪婪。在吠陀命理学中，数字四由北月交点罗睺（Rahu）统治，也称为龙头。在西方命理学中，这个数字由天王星统治。`,source:"translate-leela/locales/zh/4-avarice-zh.md"},{plan:5,title:"物理位面 (bhu-loka)",description:null,body:`未显现的现实领域被转化为名称和形式的世界。名称和形象的世界以七个不同的世间（lokas）的形式存在，或存在的层次，按升序排列。这些世间是个体意识进化的阶段。人在发展过程中，随着本性的变化而前进。通过这些层面，意识可以认识到它的真实本质。
...
微妙元素的数量有五种：以太、空气、火、水和土。一个人有五个行动器官来创造他的业力，它们是手、脚、口、生殖器和肛门。还有五种感觉器官：耳朵负责声音，皮肤负责触觉，眼睛负责形状和颜色，舌头负责味觉，鼻子负责嗅觉。五是平衡数：一个边上有两个二。掌管数字 5 的行星是水星。水星性格柔和，喜欢思考高深的事情，是科学家，也是娱乐爱好者。水星还与商业品质和身体舒适有关。`,source:"translate-leela/locales/zh/5-physicalplan-zh.md"},{plan:6,title:"妄想（moha）",description:null,body:`“moha”这个词在梵语中的意思是“执着”。这种执着是奴役束缚的原因，导致玩家在现象世界中一次又一次地出生和重生。经典中说，有四种附身会导致个人意识陷入向下的能量流动，并成为灵性成长的障碍。
...
数字六由两个奇数或三个偶数（两个三元组或三个二元）的组合组成，即由五个可能的元素组成。因此，它处于完美的平衡状态。六与独创性、创造力和美术有关。她是月球数字族的代表，与金星有关。金星是最亮、最明亮的行星，用肉眼可以看到它就像一颗晨星。在印度神话中，维纳斯（Shukra）是恶魔的老师。那些生活在幻觉中、贪爱感官享受、浪费精力满足欲望、陷入愤怒和贪婪、违背佛法法则的人，是不虔诚的，而且非常自私。`,source:"translate-leela/locales/zh/6-delusion-zh.md"},{plan:7,title:"虚荣 (mada)",description:null,body:`虚荣是自欺欺人、虚假骄傲、建造空中楼阁。在梵文中，“mada”一词除了虚荣之外，还有“陶醉”的意思。玩家会陶醉于自己的力量、真实或想象的美德和成就。当他对自己产生任何妄想时，他就会陷入疯狂的网中。进入游戏后，玩家受到玛达虚荣和各种虚假身份的影响。骄傲和虚荣是我们在恶劣环境中喝下的两种最危险的毒药。坏伙伴是妄想和贪婪的产物，是引导玩家走向虚荣的蛇。在这个领域，玩家发现自己完全陷入了自己游戏的网络中。他所处的恶劣环境就是邪恶欲望的表现。
...
传统上，七与月亮的南交点克图（Ketu）相关，也被称为龙尾。在现代印度命理学中，数字七由水王伐楼那 (Varuna) 掌管，而在西方命理学中，数字七由海王星 (Neptune) 掌管。七是那些不发达而虚荣、以建造空中楼阁、忧虑未来而闻名的作家和艺术家的数量。他们不喜欢走老路，对宗教有非常具体的看法。他们倾向于创建自己的宗教并在娱乐中度过一生。`,source:"translate-leela/locales/zh/7-vanity-zh.md"},{plan:8,title:"贪婪",description:null,body:`虚荣心让玩家意识到他开始嫉妒所有人。他被自己作为一个独立的现实的幻觉所迷惑，以至于任何满足他的欲望的方法对他来说都是正确的。毕竟，虚荣的赌徒认为，我比其他人好得多，我应该拥有他们所拥有的一切。所以，在这个游戏中，贪婪与嫉妒之蛇联系在一起，因为。虚荣心所产生的嫉妒会导致贪婪。在贪婪的状态下，玩家会对其他玩家产生积极的仇恨。他对他们来说太好了，而他们所拥有的对他们来说也太好了。因此，玩家认为，属于他们的东西就应该是我的。他变得不友善，并热衷于占有周围人的物质财富。这种感觉与贪婪不同，贪婪只看得见物质的一面。贪婪是贪婪与嫉妒的结合。随着玩家变得越来越贪婪，他们对财富的渴望也随之增加。而第一脉轮的所有其他问题也开始折磨他。
...
在月球家族的数字中，八代表一个八度，八个维度，一个八进制玛雅，由三个基纳和五个微妙元素组成。在数字命理学中，数字八与土星有关。这是一个不容易理解的星球，充满了坎坷、激烈的斗争。这是一颗与黑暗相关的空气行星。它的象征是一个沉默的思想家，沉浸在自我观察中并拥有唯物主义的观点。八字形以下出生的人热衷于积累财富，容易产生不健康的成瘾和恶习。然而，他们聪明、经验丰富，并且具有评判他人的特殊天赋。`,source:"translate-leela/locales/zh/8-greed-zh.md"},{plan:9,title:"欲界 (kama-loka)",description:null,body:`这是底行的第九个正方形。九是结束第一行的完整奇数。这是一个引导玩家进入第二个意识层次的阶梯，从净化开始。玩家出生并进入游戏后，必须经过感官位面，才能进入第二关。

Kama 的意思是欲望——任何种类的欲望。人们想要名誉、财富、成功、家庭幸福、社会地位。任何欲望、抱负、崇高或卑贱的目标都是业力。卡玛（Kama）是进化的第一阶段。如果没有欲望，就不会有宇宙。

所以，欲乐就是欲望的计划。然而，一切欲望都来自于人的欲性，所以这个层面也被称为欲性层面。这与无知、缺乏知识有直接关系。你可以通过无知之蛇的嘴到达这里，或者通过对第一脉轮的逐渐探索。九是奇数族的代表，代表完整和完美。它代表力量和能量。当乘以任何其他数字时，它保持其同一性和完整性：9x1=9； 9x2=18=9； 9x3=27=9； 9x4=36=9； 9x5=45=9； 9x6=54=9； 9x7=63=9； 9x8=72=9； 9x9=81=9； 9x376=3384=9； 9x280=2520=9。人体有九个开口，生命能量（生命能量）在死亡时离开身体：嘴、两个鼻孔、两只眼睛、两只耳朵、肛门和性器官。一天中，一个人进行21600次呼吸周期（吸气和呼气），这个数字可以减少到9次。一天由1440分钟组成，也可以减少到9次。一个半球的主导或呼吸的正常持续时间主要通过一个鼻孔进行的呼吸大约有 900 次（60 x 15），归结为 9 次。人体有 9 条主要神经。在印度教中，崇拜九位女性神（nava-durga：nava - “九”，Durga - 女神的名字）。人体中有 72,000 个通道，称为经络。它们携带着生命力，其总数也减少到了 9 颗。太阳系中有 9 颗行星（navagraha）影响着地球上的生命。在命理学中，9是火星的数字，在天空中闪耀着明亮的红光。`,source:"translate-leela/locales/zh/9-sensualplan-zh.md"},{plan:10,title:"清洁 (tapa)",description:null,body:`在第一级，玩家可能会感觉良好一段时间，但很快他就会开始缺乏生命能量，浪费在负面情绪和肉欲上。能量损失会导致内心空虚和混乱的感觉。此时，他的注意力已经被吸引到了清洗上。这是游戏板的第一个箭头开始的地方，让玩家有机会立即克服与第二个脉轮相关的所有问题。从第一个脉轮的水平移动到净化单元，玩家摆脱了前两个脉轮的所有负面方面，并转移到天界。净化总是伴随着振动水平的增加，能量开始向上流动。这个过程的发生是由于感官和行动功能的变化以及一个人生活方式的纠正。意识城堡有五个入口，敌人（污染）可以通过这些入口进入并试图推翻国王。为了保持城堡清洁，有必要关闭这些入口，或者仔细监控外部的情况。
...
一天或多天不睡觉可以消除玩家的惰性、困倦、无聊和无知。保持完全沉默一段时间可以净化思维过程。禁食可以净化身体。克服困难净化了玩家的人格，听诵经文净化了玩家的内心，念诵咒语净化了神经，定力冥想净化了身心。禁欲也是净化的方法之一。这是改变习惯性振动水平的一种困难但非常有效的方法。`,source:"translate-leela/locales/zh/10-cleansing-zh.md"},{plan:11,title:"娱乐（干闼婆）",description:null,body:`经典说干闼婆是至尊主的音符。干达婆一词被翻译为“天上的音乐家”。这是八种众生之一，普通视觉无法感知，但如果愿意，它们也可以呈现出可见的形式。它们是由微妙物质创造的，生活在星体层。这些生物的生命与神圣的音乐和谐相处，致力于娱乐众神和其他在进化过程中达到这个层面的生物。 《往世书》中有许多涉及干闼婆和飞天（仙女）的故事。最初，他们不受生死轮回的束缚，但如果他们的行为与这个存在层面的条件相冲突，他们就会坠落到地面并以人类的形式出生。然而，无论他们身在何处，生活都是为他人的娱乐服务的。玩家通关后进入娱乐区。这个层次反映了内心的喜悦、节奏感和和谐感。娱乐带来轻松的感觉，鼓励放松和享受当下。它们使单调的日常生活变得活跃起来，开辟了新的视角和视野。所有艺术品都是这种状态的产物，属于游戏板的第二排，代表第二脉轮振动的各个方面。然而，这个原则本身存在于各个层面。例如，Leela 的游戏为追求完美的人们提供了娱乐。

生活是基于娱乐的原则——享受。然而，这种人生观只有在克服了第一脉轮的水平及其主要问题——自我怀疑和对物质福祉的关注之后才能实现。娱乐是精神的本质。所有这个被创造的宇宙都是由沙克蒂（Shakti）、母亲原则、绝对、上帝……无论我们为最高玩家选择什么名字而进行的能量游戏。如果神圣游戏的本质中不包含这一原则，那么“一”就不会成为“多”。玩家越来越深入地进入作为独一者娱乐的游戏，并被其规则所渗透，以便最终与他团聚。`,source:"translate-leela/locales/zh/11-entertainment-zh.md"},{plan:12,title:"Envy (irasya)",description:null,body:`嫉妒是棋盘上的第一条蛇。它会刺痛玩家，让他们回到贪婪位面的第一层以及第一脉轮的所有其他属性。当被置于嫉妒牢房时，玩家会感到缺乏自信，并且为了压倒自己的欲望，诉诸第一脉轮的策略特征。这条蛇一次又一次地刺痛玩家，导致他们倒下，这有助于他们在游戏过程中清醒头脑。

在生命的游戏中，能量是自下而上流动的。玩家努力离开较低的层面并到达顶部，摆脱下面必须面对的问题。

然而，这样的立场违背了游戏最重要的原则之一，因为玩家必须和谐地发挥自己在上层和下层的角色，无论他的业力骰子指向何处。然而，没有人愿意继续下去。当玩家的振动变得不和谐时，他就会受到蛇的影响并坠落到较低的位面。他所有的上下移动都是由他掷骰子的数字决定的。当一个人受到嫉妒的影响时，他的能量就会下降。因缘际会，他落入了第二轮位面，但他实在不配留在这里。事实上，由于他的个性中留下了负面振动，他无法留在这个层面上。在这种时刻，玩家会羡慕那些能够保持在更高位面而不失去平衡的人。嫉妒是导致玩家跌落到第一脉轮水平的负面反应，在那里他必须意识到并解决他的负面业力的新元素。`,source:"translate-leela/locales/zh/12-envy-zh.md"},{plan:13,title:"微不足道 (antariksha)",description:null,body:`Antariksha 是位于物质层面和天堂（svarga-loka）之间的层面。在这里，玩家处于“悬浮”状态：既不在天上，也不在人间，事实上，什么都没有。
...
然而，微不足道的状态决不是永恒的。一旦玩家开始补充能量，轮到他掷骰子时他就准备好继续玩了。`,source:"translate-leela/locales/zh/13-nullity-zh.md"},{plan:14,title:"星界 (Bhuvar Loka)",description:null,body:`布瓦洛卡（Bhuvar-loka）是一个遵循物理层面并与之密切相关的层面，但由更微妙的物质组成。在bhu-loka（第一行第五个方块）的描述中，我们已经解释过有七个基本平面或lokas，反映了存在状态或人格的发展程度。在布瓦尔洛卡层面以及第二脉轮，水元素占主导地位。正如人体中的第二个脉轮位于沿着脊柱的第一个脉轮的正上方一样，星体层位于棋盘“脊柱”上的物理脉轮的正上方。
...
星体层是位于地球和天堂之间的心灵空间维度。玩家已经克服了尘世的束缚，他的幻想给了他天堂的想法。危险在于，幻想会让玩家远离现实，耗尽他的精力，并且可能无法实现。`,source:"translate-leela/locales/zh/14-astral-zh.md"},{plan:15,title:"幻想计划 (naga-loka)",description:null,body:`Naga-loka 必定是地下世界。地球平面以上有七个平面，地球平面以下有七个平面。位于地球下方的飞机位于水下。每个世界的统治者都是不同类别的存在。七个下层世界之一是帕塔帕（Patapa），其统治者是蛇（那迦）。在神话中，它们是半神生物，有着人脸和龙一样的尾巴。纳迦也被理解为一个获得伟大智慧的隐士入门者的教派。没有什么是隐藏的，也无法被他们全视的目光所隐藏。由于龙界是幻想位面，因此它并不位于地球上方，而是位于地球下方，根据称为幻想的现象的本质，沉浸在水中。
...
纳迦一词从梵文翻译为“蛇”。所以幻想位面也是蛇位面。蛇是能量的象征。瑜伽士通过练习寻求提升的昆达里尼通常被称为“蛇的力量”。在西方神话中，蛇是魔鬼的可能形式之一。蛇体现了处于第二脉轮水平的玩家固有的持续运动、灵活性和变形的品质。就像蛇躲在地下洞里一样，振动与第二脉轮相对应的玩家也是如此。`,source:"translate-leela/locales/zh/15-fantasyplan-zh.md"},{plan:16,title:"嫉妒 (dvesha)",description:null,body:`当其他人的行为与他对自己的看法不一致时，他就会对其产生怀疑。在爱情关系中，他会变得嫉妒并害怕不忠。他的疑虑与日俱增，很快他的能量又回到了第一脉轮，在那里他陷入了贪婪的网中。在自我怀疑的滋生下，嫉妒会带来安全感丧失的结果，这是第一脉轮的主要特征。缺乏自信也会导致自我憎恨，然后将其投射到不喜欢他人的负担上。

为了重获自信，玩家现在必须经历第一脉轮的体验，在那里他们可以处理其原因并提高振动。`,source:"translate-leela/locales/zh/16-jealousy-zh.md"},{plan:17,title:"慈悲（达雅）",description:null,body:`同情心是玩家内在的神圣品质之一，如此强大以至于可以将他从第二脉轮提升到第八脉轮，到达绝对层面。同情心打开了同理心的能力，使自我被强烈的情感浪潮所席卷，以至于喜悦的泪水充满了眼睛，心脏在钦佩和宇宙之爱中跳动。一瞬间，玩家与神合而为一。
...
梵文有云：“慈悲为法基”。没有这种品质，真正的宗教信仰根本不可能存在。任何时候的慈悲、仁慈、忍耐都有助于一个人良好开端的发展，帮助他净化情感、塑造品格和道德发展。人格障碍被打破，玩家的思想成为神圣的反映。慈悲就是放弃自我。然而，它无法将玩家从累积的业力中解放出来，所以他们现在必须掷骰子，直到被塔莫根广场上的蛇蜇伤，让他们返回地球完成任务。`,source:"translate-leela/locales/zh/17-compassion-zh.md"},{plan:18,title:"喜悦计划 (harsha-loka)",description:null,body:"在这里，在第二排的末端，第二个平面，第二个脉轮，玩家会感受到深深的满足感。他知道自己已经成功地跨越了嫉妒、渺小和嫉妒的境界。幻想世界的旅程结束了，他进入了现实世界并练习业力瑜伽。他不知道他多久才能实现他的目标，宇宙意识，但他可以通过自己的经验相信，他可以通过提高能量来克服存在的水平。对即将到来的与现实的冲突的厌恶感促使他加快脚步，让他开始以一种新的方式、更深入地感受自己存在的各个层面。前方等待着他的现实挑战着他，但他也保留着完成前一阶段发展所带来的满足感。一个阶段已经完成，下一阶段就在眼前。这是克服困难的时刻，玩家内心充满喜悦。他成功通过了第一查克拉，现在他并没有感到恐惧，对自己相当有信心。超越感官欲望后，他完成了第二阶段。前面是业力瑜伽的快乐实现。他感觉自己和整个世界都处于巅峰。时间感消失了：快乐永远是永恒的，无论它的时刻多么短暂。空间的限制也消失了：欢乐无国界。然而，这种快乐不可能是永久的：很快，业力的力量就开始发挥作用，促使玩家进入第三层。",source:"translate-leela/locales/zh/18-planofjoy-zh.md"},{plan:19,title:"业力计划 (karma-loka)",description:null,body:`这个平面，即行动平面（业力），打开游戏板的第三行，对应于第三脉轮。只有一种欲望始终存在于我们身边，那就是对满足的渴望。其余的一切都只是这个基本愿望的反映：对完成、自我实现的渴望。因此，无论玩家处于什么水平，他都会努力获得满足感 - 并且在那个水平上。在前两个脉轮中，这种欲望表现为对金钱和性的渴望。在第三个脉轮中，自我认同（自我）和权力的实现成为主要需求。第一脉轮的人通常不会为自己或为自己工作。它们通常服务于在第三脉轮水平振动的人们的利益。在第二脉轮的层面上，欲望指向感官对象，能量用于探索感官世界。在第三个脉轮中，玩家意识到社会和政治冲动对其人格发展的影响。因此，玩家开始意识到自己。自私成为他行为的主要驱动力，而他的自我则越来越寻求扩大其影响范围。所以业界让一个人面对现实。视角发生变化，第二脉轮崩溃的幻想特征。这是清醒的时刻。正是在这一刻，玩家意识到了业力法则的存在。

一切事物都在不断地相互作用。在能量层面上，业力决定了玩家的振动频率，这在物理层面上表现为他的行为方式。业力是生死轮回的原因，只有业力才能让玩家从这个轮回中解脱出来。业力（行动）会产生束缚，但也可以摧毁它们。

玩家对自己的“我”承担业力责任，“我”可分为显化和未显化、身体和本质。因此，有与身体有关的业和与心有关的业。第一个与这个世界上的行为有关。然而，既然意识包含了整个世界，那么与意识有关的业力也涵盖了整个世界。`,source:"translate-leela/locales/zh/19-plankarma-zh.md"},{plan:20,title:"慈善（布施）",description:null,body:`导致振动水平提升的业力行为被称为美德；那些降低振动频率的东西就像恶习。慈善是存在于第三脉轮层面的人类美德。它使玩家超越了这一级别的问题，并且他向上移动了一步，到达位于心轮水平的平衡平面。
...
慈善满足了不断发展的自我，并将玩家从第三脉轮的束缚中解放出来。慈善是业力层面传递过程中最重要的里程碑之一。这是推动人类社会活动最崇高方向之一的力量，它是同情心与第三脉轮的组织特征倾向的结合。`,source:"translate-leela/locales/zh/20-charity-zh.md"},{plan:21,title:"赎罪 (Samana Papa)",description:null,body:`从物质和感官冲动的影响范围中崛起，玩家意识到在满足这些欲望的过程中，他可能会伤害他人。为了追求满足，他盲目行动，不考虑后果。进入救赎的境界后，他发现自己走的是不正当的道路，采用了不正当的手段，在自己内心造成了不利的振动，从而阻碍了内心平静的实现。
...
在这两种情况下，悔改都会产生积极的结果并建立向上的能量流。玩家通过遵循佛法法则来弥补自己的错误，佛法法则是所有事物和现象的真实本质。赎罪调整到这个包罗万象的法则，它在游戏板上由下一个单元格表示。`,source:"translate-leela/locales/zh/21-redemption-zh.md"},{plan:22,title:"佛法计划 (Dharma-loka)",description:null,body:`佛法就是一切真实的事物，对吧。它是一个不断发展、无处不在的原则，是一种超越时空的力量，指导着人类的存在。佛法是不变的，但在不同的情况下其表现可能会有所不同。它存在于现实的深处，遵循佛法之流的人将永远与这个世界的现实和谐相处。
...
因此，佛法是一成不变的，是超越形式的，为每个参与者采取一种或另一种形式。对于生活在寒冷气候中的人来说，佛法是穿暖和的衣服；对于生活在寒冷气候中的人来说，佛法是穿暖和的衣服；饥饿者的法就是吃。对于佛法学生来说，就是冥想并遵循修行或精神纪律。孩子的佛法就是自由玩耍，不用担心精神世界。成年人的佛法是自己在精神世界的愿望和主张。佛法是维持所有造物元素之间正确关系的真理。佛法是围绕着正在建造的人格大厦的脚手架。在建筑物竣工之前，脚手架支撑其结构。但当建筑物已经能够支撑自身时，脚手架就会被拆除并用来建造新的、仍然不稳定的建筑物。`,source:"translate-leela/locales/zh/22-plandharmas-zh.md"},{plan:23,title:"天界 (svarga-loka)",description:null,body:`Svarga-loka，天界，是七个创造界中的第三个。所有这三个层面——bhu-loka、bhuvar-loka 和 svarga-loka——在造物主梵天的一天结束时被摧毁，并在第二天的黎明时再次重生。在bhu-loka层面，一切都以物质形式存在，bhuvar-loka属于欲望领域，在swarga-loka，思维脱颖而出。统治这个位面的主要力量是火元素。这里存在的一切都像火一样闪闪发光，这就是为什么居住在这个位面的生物会散发出光芒。在各国人民的神话中都可以找到关于闪闪发光的天使和神灵的描述。
...
对于征服了感官和行动器官的人来说，物质层面上存在的一切都以和谐而神圣的形式出现。无低等欲望、无暴力、无执着、无贪婪、无嫉妒、无贪财、无嗔恨、无淫欲、无渺小。相反，有洁净、怜悯、喜乐和充满享受的永生。`,source:"translate-leela/locales/zh/23-heavenlyplan-zh.md"},{plan:24,title:"坏公司 (ku-sang-loka)",description:null,body:`为了寻找第三脉轮的自我认同特征，玩家正在寻找一群可以支持他的其他人。他意识到，仅靠自己的力量不足以实现他的计划，他正在寻找其他走类似道路的人，以建立一群志同道合的人。
...
在不好的公司里，人们通常认为个人问题的原因是周围的人或社会。最引人注目的例子是恐怖分子团体不择手段地达到目的。他们以崇高的目标为自己的行为辩护，结果只会互相误导。他们认为杀死某些人可以满足他们的欲望。他们盲目地相信自己的目标是每个人唯一正确的目标。这种偏离佛法的行为是对权力的严重滥用，是第三脉轮层面的主要问题之一。与坏公司交往是一种会导致垮台的恶行。玩家只有认真遵循佛法原则才能避免这个陷阱。`,source:"translate-leela/locales/zh/24-badcompany-zh.md"},{plan:25,title:"好伙伴（su-sang-loka）",description:null,body:`开始遵循第三脉轮佛法之路的玩家很快就会发现自己处于一个努力发展和实现自己最佳特征的社会中。在这样的环境中，玩家会发现自己的能量因确认自己的搜索真相而增加，并意识到还有其他人与他追求相同的目标。第三脉轮的主要要求再次发挥作用——自我的扩展。这个积极的社区被称为su-sang。
...
良好的陪伴是第三脉轮固有的自我认同和自我肯定渴望的积极方面。玩家通往游戏第四层（宇宙智慧与平衡位面）的道路上不再有任何障碍。`,source:"translate-leela/locales/zh/25-goodcompany-zh.md"},{plan:26,title:"悲伤（dukkha）",description:null,body:`悲伤是一个术语，用于描述因失去某物而引起的身体化学变化。这种能量损失和相关的能量压力过大会导致身体处于抑郁状态。悲伤和快乐是情感连续体的两个极点。快乐是一种扩张、外向和振动升高的状态，而悲伤是一种收缩、内向和压抑振动的状态。在这两种情况下，时间感都消失了，这一刻似乎是永恒的。
...
然而有一条路给了他希望。这是无私的服务，由棋盘上的下一个方块代表。`,source:"translate-leela/locales/zh/26-sadness-zh.md"},{plan:27,title:"无私服务 (paramartha)",description:null,body:`如果慈善涉及不时进行的行动，那么无私的服务就是一种永久的立场，一种存在的方式。帕拉玛莎（Paramatha）在不关心自己的情况下与外界和谐相处，做需要做的事情，同时保持对当前时刻的意识。
...
没有人能保证一定会得到回报：无数因素会影响任何案件的结果。如果球员没有希望和欲望，那么每一刻对他来说都是一种成就。他摆脱了得与失的错误态度，实现了无私的服务，箭将他带向人间。以正确的方式履行自己的职责，为了需要做的事情而放弃自我，会导致身份的丧失，这是第三脉轮的主要问题。个性不再作为一个单独的单位存在，而是成为一个更大整体的一部分。这种事工的例子可以在各种体现天国计划的组织中找到。无私服务是游戏板第三排的最后一个方块，代表第三脉轮。从这里，玩家上升到平衡平面，即信仰和奉献的平面。`,source:"translate-leela/locales/zh/27-selflessservice-zh.md"},{plan:28,title:"真正的宗教信仰 (sudharma)",description:null,body:`Sudharma，或真正的宗教信仰，意味着采取最适合玩家的方向和行动方针。 Sudharma 是与游戏规则和谐相处的生活。这是一个行动方向，允许玩家掷骰子而不用担心它会落在哪里。
...
在第三个脉轮中，他必须认同一群志同道合的人，在第二个脉轮中，他必须认同自己的感受，在第一个脉轮中，他必须有能力确保自己的身体生存。在第三轮，他了解业力的法则、布施的意义、佛法的道德层面、善恶环境的后果、生命的救赎和痛苦。但是，只有达到第四脉轮的水平（即苏达摩领域），才能理解自己在游戏中的角色，从这个水平进入禁欲主义的层面，进行严格的自我约束和自我努力。沿着苏达摩的道路，他会直接到达棋盘的第六行，第六脉轮。`,source:"translate-leela/locales/zh/28-truereligiosity-zh.md"},{plan:29,title:"缺乏宗教性 (Adharma)",description:null,body:`进入sudharma细胞的玩家发现了自己在游戏中的角色，并开始按照它行事，而不注意后果。他知道，只要倾听内心的声音，他就没什么好害怕的。符合自然法则的信仰就是苏达摩。盲目的信仰，忽视宇宙的原则，会导致不法。本质上，所有违背个人佛法的行为都是不法行为。 Adharma 会让人误入歧途，让他回到第一个脉轮，回到妄想，这是盲目信仰的本质。
...
信仰是第四脉轮的本质：信仰、奉献、奉爱。如果玩家的行为与他的真实本性（sudharma）和谐一致，这种信念就会将他提升到苦行的境界。但如果他偏离了正确的道路，同样的信仰会使他再次陷入错误。这是不法的。仅基于信仰的行为会使人远离真正的宗教信仰。不植根于对存在法则的理解的信仰是盲目的。而这种盲目的信仰是这个位面能量损失的最常见原因。与存在法则和谐一致的信仰是sudharma；正义的信仰是不道德的。`,source:"translate-leela/locales/zh/29-lackofreligiosity-zh.md"},{plan:30,title:"良好趋势 (uttama gati)",description:null,body:`Uttama 的意思是“好的”，gati 的意思是“运动”。如果一个球员的行动与宏观宇宙的法则相一致，那么他的良好倾向就会自然而然地出现在他身上。只要它在较低的三个平面上振动，这些趋势就不会发展。他们的成长只从第四脉轮开始，因为它需要达到一定程度的内在平衡。
...
良好倾向的练习有助于球员稳定自己的生活，使其朝着积极的方向有节奏地发展，免受低层中心的能量耗散影响。`,source:"translate-leela/locales/zh/30-goodtrends-zh.md"},{plan:31,title:"圣洁计划 (yaksha-loka)",description:null,body:`进入神圣层面的玩家通过对宇宙原理的理解体验神圣的恩典。圣洁是良好倾向的直接结果。这是与第四脉轮相关的神圣存在的一体感，以及在所有造物中看到他的恩典显现的能力。这种统一超越了单纯的智力理解，成为日常生活的真实组成部分。
...
当玩家达到夜叉洛卡时，他的注意力就会被吸引到神圣存在的本质问题上。他试图寻找神与他日常生活之间的联系。他追求真正的体验，这只有在达到第四脉轮之后才有可能。以前，这只是一个抽象的概念。现在，对神性及其在所有造物中的存在的兴趣、面对现实的渴望成为玩家的本质。`,source:"translate-leela/locales/zh/31-planofholiness-zh.md"},{plan:32,title:"平衡计划 (Mahar Loka)",description:null,body:`马哈洛卡 (Mahar-loka) 是存在的七个层次中的第四个洛卡。据信，这个世间在造物主梵天之夜开始时被摧毁。前三个世间是个体意识（jiva）生存的场所，在一系列新的重生中发展。在第四个世间，和第三个世间一样，火元素占主导地位，但这里不像斯瓦尔加世间那么美丽，那里的居民的身体闪闪发光并散发出光芒。
...
在日常的印度教礼拜仪式（sandhya）中，礼拜者会背诵列出七个主要世间的咒语。当念出每个位面的名称时，他会触摸与该位面相关的身体部位。他用右手湿润的指尖触摸肛门和生殖器之间的点，也就是昆达里尼的位置，发出“唵bhu”的声音。然后他念“Om bhuvah”，触摸性器官的底部，也就是第二个心灵中心所在的地方。他一边触摸肚脐，一边念诵“唵唵”（Om swah）。他唱 Om maha，同时触摸心脏，Om jana - 到喉咙底部，Om tapa - 到第三只眼，眉毛之间的点，就在鼻梁上方。最后，唵萨蒂扬（Om satyam），触摸头顶。`,source:"translate-leela/locales/zh/32-balanceplan-zh.md"},{plan:33,title:"香水计划 (gandha-loka)",description:null,body:`犍陀罗的意思是“嗅觉”，嗅觉与地元素和物质层面有关。然而，当玩家达到第四级时，感官知觉的本质发生了转变，成为神圣的象征性表达，携带着强大的情感电荷。在他们的苏达玛之后，信徒们以鲜花或焚香的形式向神灵供奉芳香。因此，第四脉轮包括香气层面，或犍陀罗卡。
...
为了发展理解，鼓励从事精神实践的人们停止使用人造体香，以识别他们的自然气味。当身体的臭味消失，排泄物、汗水、呼吸都不再带有臭味时，这意味着一个人的能量已经克服了第三脉轮，进入了犍陀罗卡（Gandha Loka）——香气层面。这里只有神圣的气味。玩家一劳永逸地清除了他系统中的难闻气味。`,source:"translate-leela/locales/zh/33-aramat-zh.md"},{plan:34,title:"品味计划 (rasa-loka)",description:null,body:`在较低的脉轮中，味觉主要是一种感官知觉的形式，而在第四脉轮中，味觉被提炼为审美意义上的味觉。进入这个层面的人就会深入到思想和意义的世界。这让他对情感体验的本质有直接的、经验性的了解。

Rasa 是爱、愉悦、优雅、娱乐、品味、情感、美丽、激情、精神。这是诗意的灵感，是诗的本质。种族是最纯粹形式的水，是将所有造物结合在一起的力量。

直到第三脉轮，这个词的所有含义的品味几乎完全针对较低水平的活动。在第一脉轮中，品味完全服从于赚钱的欲望。提供大量力量的食物（尤其是肉类）和现成的购买食物构成了玩家饮食的基础。它使用大量的盐和香料。在第二个脉轮中，能量被导向性感。在这里，玩家对增强功效的食物感兴趣，例如鸡蛋、鱼或人参。在第三脉轮中，他为了味觉本身而寻求味觉，食用各种美味的食物。在心的层面，味觉得到净化。玩家留下盐和糖是为了了解他所吃食物的真实性质。当玩家进入品味层面时，他的品味在各个方面都会变得精致。他对食物、音乐和交流的偏好让每个人都感到愉快，无论他们的水平如何。他成为了大家公认的鉴赏家和鉴赏家。因此，他吸引了想要达到这样状态的粉丝。`,source:"translate-leela/locales/zh/34-tasteplan-zh.md"},{plan:35,title:"炼狱 (naraka-loka)",description:null,body:`在玩家达到心灵层面之前，他缺乏对sudharma或真正宗教信仰的理解。没有sudharma，就不可能有行动自由。但一旦玩家获得了行动自由，他就应对其后果负责。 Naraka-loka 是玩家对其“账户”负责的地方。

在印度教宇宙论中，naraka loka 位于地球和天堂之间。这个计划由七层组成，玩家在到达天堂之前必须克服这些层。根据自己的业力，玩家在每一层都会花费一些时间，那么，如果他也有善业，他就会升天。

纳罗卡世间的主宰是阎罗王，死亡之主，也称为法王。暴力会将玩家带入炼狱，进入最痛苦的境地。每一个行动都会结出相应的果实。这就是业力法则，只要玩家继续肉体存在，其影响就不可避免。恶业会引导玩家走向 naraka-loka，到达与此业力相对应的地方。这不是惩罚，而是净化。纳拉卡领主法王对于前往那里的玩家的痛苦没有个人兴趣。相反，他的工作是纠正消极情绪，为未来的精神发展让路。 Naraka 也是心轮本身。对感受的执着是naraka，执着的感觉是naraka。 Naraka 是负面振动。一个散发出消极情绪的人会根据他的能力在自己的房子、家庭、地区、城市、国家或世界中创造naraka。在没有第四层固有的理解的情况下进入naraka-loka，玩家将这种情况视为失败，他看不到其中负面业力的后果。那么很明显，naraka-loka只不过是行为不完美的表现，必须予以纠正。在第四个脉轮中，有没有评估的意识。`,source:"translate-leela/locales/zh/35-purgatory-zh.md"},{plan:36,title:"头脑清晰 (svaccha)",description:null,body:`头脑的清晰是当玩家离开第四关进入第五关时充满的光明，在那里人类成为人类。在梵文中，svaccha这个词的意思是“纯净、清澈、透明”。这种透明度是玩家在纳拉卡世间经历净化过程的结果。
...
进入svaccha场，玩家变得纯净透明。他被怀疑所征服，因此他偏离了真正的宗教道路，或者最终陷入了炼狱。但这次经历让他对苏法有了了解。他培养了良好的倾向并圣洁了他的生活。他已经访问了香气和味道的层面，现在准备加入向上的能量流，将他带到第五脉轮。`,source:"translate-leela/locales/zh/36-clarityofmind-zh.md"},{plan:37,title:"智慧 (jnana)",description:null,body:`对真理的认识和理解在日常生活中将真理付诸实践的正确方法是智慧的两个基本特征。智慧是将玩家提升到位于脉轮之外第八行的幸福平面的力量。了解自己在游戏中的角色以及使他能够履行这一角色的行动的本质的玩家会生活在幸福之中。玩家只有体验到头脑清晰，才能实现自己的智慧。只有当所有的评估和判断都被暂停时，能量的转变才会发生，这使得他能够上升到第五脉轮。
...
智慧领域正确地位于第五脉轮的水平，因为这里是数十亿空白页的来源，这是所有世界宗教教义的本质。在第五脉轮中，玩家主要关心的是与他人的沟通：他试图向他人传达他所实现的对游戏本质的理解，同时意识到这是不可行的。`,source:"translate-leela/locales/zh/37-jnana-zh.md"},{plan:38,title:"普拉纳洛卡",description:null,body:`普拉纳是生命力。在梵语中，它是生命的同义词，也是我们每次呼吸所接收到的生命气息的名称。普拉纳也是体内五种主要微妙能量之一的名称。从狭义上讲，普拉纳是指位于口腔中并将食物运送到胃中的能量。普拉纳位于从鼻孔到肺部并靠近心脏的区域，保护生命免受破坏。
...
在瑜伽中，普拉纳是一个至关重要的概念。通过练习调息，瑜伽修行者引导普拉纳流向下至骨盆神经丛，在那里与阿帕纳（位于下半身的能量）混合。当普拉那（prana）和阿帕那（apana）一起流过中脉（脊柱的中央通道）到达头顶时，瑜伽士体验到三摩地（samadhi），这是所有瑜伽练习的目标。普拉纳不应与氧气混淆。氧气为整个身体提供能量。另一方面，普拉纳维持着肉体的存在：普拉纳就是生命本身。为了理解普拉纳，生命和意识必须分开考虑。生命是意识显现的机制，普拉纳是其驱动力。当生命停止时，意识仍然存在。许多记录在案的转世案例表明了这一点。`,source:"translate-leela/locales/zh/38-pranaloka-zh.md"},{plan:39,title:"阿帕那洛卡",description:null,body:`普拉纳是通过肺部吸收外部能量并将食物能量输送到胃的力量，而阿帕纳则具有相反的功能。 Apana 字面意思是“向下”，这种能量负责身体能量的释放。它位于身体的下部，有助于孩子离开子宫。这是向下方向释放能量的原因。 Apana 是负责排尿、排便和射精的能量。
...
瑜伽规定的收束锁练习会引导呼吸向上。当它到达肚脐区域时，它会增加消化之火。然后阿帕纳与第三脉轮中的火混合并渗透到第四脉轮中，在那里与普拉纳混合。普拉纳本质上是热的。这种混合导致热量进一步增加，两种能量都上升，形成真空。经文说，借助普拉纳与阿帕那混合产生的强烈热量，昆达里尼苏醒并进入中央通道，就像一条蛇爬进洞里一样。普拉那（prana）和阿帕那（apana）的混合可以使瑜伽修行者的身体恢复活力；他变得充满生机、坚强、精力充沛，就像十六岁时一样。因此，在这个领域中，玩家认识到阿帕那在生活中的重要性，并学习如何通过适当的饮食和其他练习来使能量保持在和谐的状态。`,source:"translate-leela/locales/zh/39-apanaloka-zh.md"},{plan:40,title:"Vyana-loka",description:null,body:"维亚纳（Vyana）吸收肺部的能量并将其分配到所有身体系统。这种生命能量负责血液的流动、腺体的分泌、身体的上下运动以及眼睑的开合。维亚纳通过毛细血管系统携带血液中的氧气。氧气和能量被吸收到组织中，废物被排出到血液中。这些血液通过 vyana 流回静脉系统，将受污染的废血带回心脏和肺部。维亚纳还负责排汗。汗水不是在某个特定的地方排出的，而是通过我们身体的每个毛孔排出的。普拉纳（Prana），即肺部区域的生命能量，无法完成这项工作；普拉纳（Prana）是肺部区域的生命能量。这同样适用于apana，它的作用是排出身体的下部。汗水不能自行移动，它是由 vyana 驱动的，vyana 存在于全身各处，在血液循环、出汗和咳嗽过程中维持化学平衡方面发挥着重要作用。",source:"translate-leela/locales/zh/40-vyanaloka-zh.md"},{plan:41,title:"人类平面 (jana-loka)",description:null,body:`Jana-loka，第五层面的第五层面，是成就者（已达到高度发展并拥有使他们能够执行对较低层面的人们来说“超自然”的行为的力量）和圣人的居所，不断地沉浸在对主哈里（毗湿奴的名字之一）的沉思中。
...
在这个层面上，玩家了解人类的真正意义。通常，这是从第三脉轮的水平直接通过从无私服务领域引出的箭头来实现的。`,source:"translate-leela/locales/zh/41-humanplan-zh.md"},{plan:42,title:"阿格尼计划 (Agni-loka)",description:null,body:`阿格尼是同一神圣本质无尽循环重生的最纯粹的体现。火同时是精神、灵魂和身体。这整个世界，充满了各种生命和现象，包括人类，都是从神火中诞生的。象征火的神像有三张脸，代表三种火：帕瓦卡（pavaka）——电火、帕瓦玛那（pavamana）——摩擦产生的火，以及舒奇（shuchi）——众神的火，在《梨俱吠陀》中被称为外什瓦那拉（Vaishvanara）——一种活生生的磁火。渗透到整个宇宙。 Vaishvanara 这个词也经常被用来指代更高的自我。
...
这些女人的欲望点燃了神火，很快她们就准备好了性交。阿格尼倾倒了种子，它变成了大地。因此，我们的星球是阿格尼的创造物，从他在巢穴中央点燃的火焰中诞生。现代科学声称地球曾经是一个火球（烈火）。水冷却了地球表面，为生命的出现创造了可能性。即使现在，火仍然存在于地球的核心，表现为从地球深处喷出炽热熔岩的火山喷发。当这种内在的火焰熄灭时，这个星球上的生命就会停止。`,source:"translate-leela/locales/zh/42-planagni-zh.md"},{plan:43,title:"人类的诞生 (manushya-janma)",description:null,body:`穿过烈火位面让玩家为成形（出生）做好准备。 Manushya-janma 标志着这一活动的结束。在第二个脉轮中受孕，在第三个脉轮中喂养和长大，在第四个脉轮中充满人类情感，玩家现在已经准备好出生了。
...
人是一个理性的存在。这种理性的天赋帮助他将自己所有的思想、言语和行为与事实联系起来。一个人的生活与真正的法则不符，就没有充分的权利被称为一个人。它是生活在人体中并努力出生为人类的其他生物。`,source:"translate-leela/locales/zh/43-birthofman-zh.md"},{plan:44,title:"无知（avidya）",description:null,body:`进入无知领域的玩家会忘记存在的虚幻本质，并执着于某些情绪状态或感官知觉。被无知之蛇蜇伤的玩家的能量会下降到第一脉轮和感官层面的水平。失去对玛雅（幻觉）本质的理解会导致他的智力变得模糊，并导致对某些状态的认同。
...
只有当玩家能够不断地追随他自己的声音、他的“我”的声音、他的存在时，他才不会成为他心灵的受害者。头脑是一只生活在欲望森林里的老虎，被充满猎物的现实所包围。玩家只有跟随自己内心的声音，才能避免落入老虎的魔掌，避免跌回感官层面。否则，他将不得不重新开始，才能最终带着正知之箭崛起。无知的领域正确地位于第五脉轮的水平，在棋盘的第五行。这里是智慧的领域（jnana），也只有在这里才能找到它的对立面——无明。由于无知，玩家倾向于将 jnana 的空白页上所写的内容视为唯一的现实（参见第 37 字段“jnana”的评论）。因此，只有上升到可能有真正的知识和智慧的水平，无知才可能成为可能。`,source:"translate-leela/locales/zh/44-ignorance-zh.md"},{plan:45,title:"正知 (suvidya)",description:null,body:`如果智慧是真理的实现，那么“正确的知识”包括意识和行为（实践）。这种组合将玩家提升到第八层面，即宇宙良善的领域。现在，他离目标只有一步之遥了。他意识到自己是微观世界中的宏观世界，是水滴中的海洋。
...
正确的知识领域完成了第五脉轮的通过，即游戏的第五行。在这个阶段，玩家充分意识到自己与宇宙的统一，他与终极现实融合，并提升到楼陀罗（湿婆）平面，宇宙良善的平面。`,source:"translate-leela/locales/zh/45-correctknowledge-zh.md"},{plan:46,title:"号计划歧视（Viveka）",description:null,body:`现象世界中存在的一切都不是现实。感知的对象随着时间的推移而变化，它们发展、成长和崩溃。但这些感官知觉的物体创造了一种完全的现实幻觉。人非常重视客观世界，并对感官知觉的对象产生认同的欲望。 Viveka或歧视是使他免于陷入物质依恋的欲望的力量。这是玩家内心智慧的声音，让他能够辨别细微与粗暴，看到万象中的本体。
...
在玩家到达第六脉轮之前，“歧视”这个词对他们来说意义不大。但通过第六脉轮是由业力骰子的落下和维维卡内心声音的提示决定的。`,source:"translate-leela/locales/zh/46-distinction-zh.md"},{plan:47,title:"中立计划（萨拉斯瓦蒂）",description:null,body:`人体的精神能量流经脊柱的中枢神经管，或称萨拉斯瓦蒂。根据瑜伽哲学，这种能量流从第一个脉轮开始，并随着玩家从一行移动到下一行而逐渐升高。瑜伽的最终目标是将这种能量提升到位于头顶的第七脉轮。
...
亚穆纳河（贾姆纳河）是印度三大圣河之一，在印度北部北方邦省的普拉亚格拉杰（现阿拉哈巴德）交汇。克里希纳诞生于亚穆纳河畔。`,source:"translate-leela/locales/zh/48-sunnyplan-zh.md"},{plan:49,title:"月球计划 (ganga)",description:null,body:`进入这个位面的玩家会发现自己处于女性磁力能量的源头。在这里，它受到位于脊柱左侧的伊达-纳迪神经的影响。艾达，根据其女性（滋养）性质，被认为是身体营养的来源。女人总是充满魅力、充满魅力，而男人则是充满力量、充满活力。
...
瑜伽的一般规则是：白天以左鼻孔为主，晚上以右鼻孔为主。白天，月球呼吸是必要的，以补偿太阳能的优势，而夜间，太阳能的呼吸是为了平衡月球的优势。`,source:"translate-leela/locales/zh/49-lunarplan-zh.md"},{plan:50,title:"禁欲主义计划 (tapa-loka)",description:null,body:`就像在第五脉轮中一样，知识对于玩家来说是最重要的，在这里，在禁欲主义的层面上，玩家的所有愿望都集中在苦行和苦行上。 Tapas这个词的意思是“禁欲主义”、“禁欲”、“燃烧”。这就是自我否定冥想的练习。
...
每个玩家对其他玩家都有特殊效果，具体取决于他当前所在的级别。第一脉轮的人的存在会给人留下可怕或可怜的印象。他要么积极地争取身体生存，要么痛苦地抱怨自己无法实现这一目标。第二脉轮的人专注于感官欲望的满足，寻求迷惑他人，他的声音诱人而甜美。振动达到第三脉轮的玩家会不断寻找对自己的挑战。他尽可能地确认他的“我”，并寻求对他已经获得的美德的更多确认。第四脉轮的玩家激励着周围的玩家。他已经找到了自己的情感中心，并且不会产生威胁性的振动。处于第五脉轮水平的玩家拿着一面根据自己的经验创建的镜子，其他玩家可以在镜子中看到自己的倒影。人类第六脉轮的存在打开了神性。在他旁边，其他玩家失去了自我认同，内部障碍消失了，他们努力将自己的意识与在禁欲主义计划中确立自己的人的意识联系起来。`,source:"translate-leela/locales/zh/50-planofasceticism-zh.md"},{plan:51,title:"地球 (prithivi)",description:null,body:`大地象征着伟大的母亲原则。这是意识发挥其永恒游戏“Leela”的舞台。在这里玩家了解到地球不仅仅是土壤，而是地球母亲。玩家发现了新的模式和和谐，新的游戏方式，这些都是以前隐藏在较低脉轮所产生的迷雾中的。
...
玩家对地球了解得越多，就越能体会到维持地球表面生命的难以捉摸的平衡。对于第一轮的人来说，她只是一个可以拿走任何东西的箱子，而不用考虑后果。当第六轮人看到他所爱的星球正面临巨大危险并可能遭受无法挽回的损害时，他意识到这种态度的致命性。`,source:"translate-leela/locales/zh/51-earth-zh.md"},{plan:52,title:"暴力计划 (himsa-loka)",description:null,body:`达到第六脉轮的玩家会体会到万物一体。人体只是短暂的形式。所有玩家的真正本质都超越了名称和形式的范畴。玩家知道死亡只是生活场景的改变。危险在于，玩家会开始诉诸暴力，因为他清楚地知道自己的行为最终不会对其他玩家造成真正的伤害。
...
流动性和灵爱的缺乏导致玩家需要在炼狱中进行更多的忏悔，必须发自内心的忏悔，才能继续游戏并寻求灵爱之路。`,source:"translate-leela/locales/zh/52-planviolence-zh.md"},{plan:53,title:"流体计划 (Jala Loka)",description:null,body:`水的性质是冷的，它吸收热量，带来凉爽。第六脉轮的禁欲主义热度，即苦行，使玩家变得残酷。他需要穿过液体位面清澈的水域，才能熄灭暴力的燃烧能量，并将其转化为精神之爱的均匀温暖。
...
水没有自己的形状，它以它所在的容器的形式呈现。这也是第六脉轮玩家的主要属性——成为与自我相反的人的能力。当玩家失去玩家身份时，真正的游戏就开始了。在第六脉轮和变得无形的能力出现之前，玩家是金钱、性、权力、业力和对知识追求的囚徒。游戏从第六脉轮开始，此时知识已经获得，并且将玩家与形态等同的幻觉已经消散。`,source:"translate-leela/locales/zh/53-fluidplan-zh.md"},{plan:54,title:"灵性奉献计划 (bhakti-loka)",description:null,body:`巴克提（Bhakti）或精神奉献是基于这样一句话：“爱是神，神就是爱。”巴克塔奉献者热爱他的神祇。神灵是情人，奉献者是情人。奉献者因分离而痛苦，渴望见到她的爱人，或者至少瞥见她的爱人。没有什么能吸引他，没有什么能吸引他的注意力，其他一切都失去了意义。食物、睡眠、性、依恋、事务——其他都不重要。他完全沉浸在分离的感觉中，在狂喜中只祈求至少能得到至尊主的一眼。当奉献者受到神圣恩典的祝福时，他会体验到不可分割的一体性，并建立起非二元的意识状态。他和他的神现在合而为一，对神的体验本身就是来自神性的恩典和祝福的证据。
...
智慧使玩家成为圣人，而巴克提则将他变成一个神圣的孩子，躺在母亲的膝上，受到父亲的仁慈保护。聪明人要遇见主，还有很长的路要走。奉献者总是被他的神所包围，他以无数的形式和名字出现在生活经历的每一个细节中。`,source:"translate-leela/locales/zh/54-planofspiritualityanddevotion-zh.md"},{plan:55,title:"自私 (ahamkara)",description:null,body:`Aham 的意思是“我”或“我七岁”。卡拉是“形式”。当“我”形成时，它就变成了 ahamkara。如果玩家性格中的活动中心变成了他的“我”，那么他的阿罕卡拉就会被玛雅人困在“我”和“我的”的概念中。当 ahamkara（实际上是现实的最高面向）忘记了认同整体的需要并成为一个单独的部分时，它；变成自私。
...
如果玩家过于以自我为中心，自我就会变成自我主义。在印度神话（往世书）中，有很多这种自私的例子，而这种自私总是在严格的禁欲主义和苦行之后实现的。在申请人寻求权力或权力的报酬，却成为自私的受害者后，他宣称自己是上帝。由于这种错误的认同，他总是堕落到第一轮，带着与生俱来的愤怒、贪婪、痴迷、虚荣和贪婪。整个星球一片混乱。在其中一个例子中，地球以一头牛的形式出现在毗湿奴面前，请求他将她从自私的负担中解放出来。在那一刻，正如史诗中所描述的，生命的伟大保护者毗湿奴在地球上成形并诞生。在《莉拉》中，上帝出来杀死玩家体内的自私之龙，因为自私是违反守恒定律的。阿罕卡拉是毗湿奴的食物，宇宙意识是他的居所。`,source:"translate-leela/locales/zh/55-selfishness-zh.md"},{plan:56,title:"原始振动计划（Omkara）",description:null,body:`唵（OM）是宇宙中无处不在的单一声音，无论是显性的还是隐性的。它是能量存在的最微妙的形式。 Omkara 是产生与所有其他振动和谐的宇宙声音的振动平面。到达这里的玩家意识到 Om 是一种充满存在所有元素的振动。
...
萨斯喀彻温大学进行的一项研究证实了吠陀经的主张，唵使人能够获得在其直接生活经历中从未存在过的知识。 200 名学生组成的小组唱“唵”，试图解决一个实验参与者都不知道答案的问题。经过一小时的歌唱后，其中一名学生从唵帮助下打开的宇宙知识宝库中得到了答案。`,source:"translate-leela/locales/zh/56-planinitialvibrations-zh.md"},{plan:57,title:"飞机 (vayu loka)",description:null,body:`Vayu Loka（字面意思是“空中飞机”）位于游戏板第七排的 Satya Loka（现实平面）区域。这个 vayu 不是在物理或地球层面上发现的风或空气。这是物理元素空气的本质。
...
在第六脉轮中，我们遇到了液体平面，但液体仍然具有形态。另一方面，气体没有明确的形状。液体有重量，气体没有。玩家不再受到任何负担，他获得了真正的行动自由。他成为一个不受重力且没有形状的存在。`,source:"translate-leela/locales/zh/57-plangas-zh.md"},{plan:58,title:"光辉计划 (Teja Loka)",description:null,body:`Teja 的意思是“光、光辉”。 《奥义书》谈到了四种意识状态，或“我”。让我们列出它们：
...
没有一个箭头通向光辉位面，也无法从下面的位面直接到达它。玩家必须慢慢地、逐渐地走向它，除非他通过练习精神奉献而获得最终的解放。`,source:"translate-leela/locales/zh/58-radianceplan-zh.md"},{plan:59,title:"现实计划 (Satya Loka)",description:null,body:`Satya Loka 是位于游戏板脊柱的七个主要 Lokas 中的最后一个平面。 Satya Loka 的主要元素是 Akasha Tattva。在这里，玩家到达了 Shabda-Brahman 的世界，并处于从重生循环中解放出来的边缘。他已经到达了最高的层面，超越了外琨塔，宇宙意识的所在地。萨蒂亚洛卡（Satya loka）不会在造物主梵天之夜消失。 Shabda 是 Om 一词，即婆罗门本身（绝对现实、宇宙意识）。 Shabda-Brahman 是原始振动平面 - Omkara。通过这个位面之后，玩家就能够扎根于现实之中。
...
但即使在这里，玩家也还没有获得解放。在这里，在游戏的第七层，有三条蛇。第一个是自私。二是负性智力。第三个是塔玛斯。到达现实位面后，玩家已经逃脱了其中一条蛇，但前方还有两条蛇，挑战着他的解放之路。如果玩家还没有完全摆脱怀疑和懒惰，他就会成为其中之一的受害者。但如果他设法让自己的思想远离消极情绪，并且他的业力已经结束，他将成功地通过塔玛斯和幸福之蛇（sukha），第八层的计划和宇宙意识在前面等待着他。他意识到自己面临的危险，并明白他必须采取正确的行动来实现自己的目标。随着对现实层面的认识，他认识到仅仅处于第七脉轮的水平并不能获得解脱。他还有更多的业力要完成。他前面不再有箭推动他前进，不再有能量突然向上运动。他必须按照他的业力走他的路。`,source:"translate-leela/locales/zh/59-planeofreality-zh.md"},{plan:60,title:"正智（Subbuddhi）",description:null,body:`须菩提是只有达到实相层次后才能获得的正知。当玩家达到萨蒂亚洛卡（Satya Loka）后，他的意识变得完美且摆脱了二元性，并且理解了这个世界上所有形式和现象的神圣。这个意识就是菩提。
...
顺觉的积极振动是通过遵循佛法的道路来实现的——在佛法的细胞上，箭头从那里开始，通向这个平面。积极的智力与玩家的佛法流相结合是游戏中帮助玩家寻求解脱的两个最强大的工具。`,source:"translate-leela/locales/zh/60-positiveintelligence-zh.md"},{plan:61,title:"负面情报 (durbuddhi)",description:null,body:`如果玩家不遵循佛法法则，在每次经历中怀疑存在的宇宙本质和神圣存在，那么他就会被负面智慧之蛇咬伤，将自己跌落到微不足道的层面。
...
然而，微不足道只是暂时的状态。只有宇宙意识是绝对和永久的。如果玩家再次到达第七脉轮，他们被强制放逐到虚无可能会让他们内心需要保持积极的智力并避免这条蛇的下颚。`,source:"translate-leela/locales/zh/61-negativeintelligence-zh.md"},{plan:62,title:"计划幸福（sukha）",description:null,body:`身心化学的平衡就是幸福。 Sukha（快乐）是玩家通过辨别（viveka）或念诵 Om、达到三摩地并保持积极的智力而达到的状态。
...
真正的幸福属于在接近目标的同时保持平衡的玩家。整个游戏很重要。他稳定的智力使他能够清楚地看到流动的形式、佛法的流动。他接受生活给他的一切。没有什么是他会拒绝的。即使他已经到达了第八位面，必须再次返回地球，但知道自己能够达到的目标，他仍然很高兴。`,source:"translate-leela/locales/zh/62-happiness-zh.md"},{plan:63,title:"塔马斯",description:null,body:`在梵文中，tamas一词的意思是“黑暗”、“黑暗”。黑暗是指没有光。光是知识，黑暗是无知；无知是低等的心。在梵语中，这个词还有第二个含义——“蛇”。塔玛斯是黑暗之蛇，是游戏中最长的蛇，它无情地将玩家从现实位面的光辉中拉入幻象。
...
这就是为什么狒狒区域位于游戏的第七层。这就是塔玛斯变成蛇的地方。在较低位面，塔马斯对于玩家来说是必需的。但在这里，在冥想的层面上，这是一种无为的形式，塔玛斯是一条扭转能量流动的蛇，导致玩家重新陷入幻象。塔玛斯（Tamas）是塔莫古纳（tamoguna）的一个属性，是它在微观世界中的体现。当相同的力量被讨论为游戏第八行中的原质属性时，它被称为塔莫古纳（tamoguna）。`,source:"translate-leela/locales/zh/63-tamas-zh.md"},{plan:64,title:"非凡位面 (prakriti-loka)",description:null,body:`在《薄伽梵歌》中，圣奎师那谈到了原质的双重本质：它既是显现的又是神圣的。显现的原质是物质世界，由元素组成：土、水、火、空气和以太（阿卡什），以及心智（玛纳斯）、智力（布迪）和自我（阿罕卡拉）。这些是原质的八种粗显表现。神圣原质（divine prakriti）是玛雅-沙克蒂（Maya-Shakti）。在描述了原质的八重表现后，克里希纳对阿朱那说：“也了解我的另一个原质，最高的，是所有存在的生命，它支撑着这个世界。”
...
穿越现实层面，玩家到达原质界，三种属性和五种元素以最纯粹、最本质的形式出现在他面前。`,source:"translate-leela/locales/zh/64-phenomenalplan-zh.md"},{plan:65,title:"室内空间计划 (uranta loka)",description:null,body:`离开第七行并认识到原质的存在，玩家开始洞察现象世界所有现象的源头——伟大意识。玩家与它融为一体，在那一刻所有的二元性都消失了。玩家获得了巨大维度的纯粹体验，以及他的“我”内部的无限空间。

Ur意味着一个人的“我”的感觉，ant-“结束”。乌兰塔洛卡是一个人独立的“我”的感觉结束的地方，任何分裂都消失，玩家陷入内心生活难以形容的深处。一口气之间，他看到了整个造物的诞生、发展和随后的毁灭。他看到所有界限和区别的虚幻本质。在认识到原质的本质和所有造物背后的统一性之后，他现在与这种统一性融为一体。这里没有任何感觉或感觉。 “我”充分意识到自己是一个不变的观察者。没有善，没有恶，没有罪恶，没有美德。玩家变得像一块纯粹的透光水晶。在《往世书》和《Samhitas》中，人们可以找到对 uranta-loka 的描述，这些描述是由经历过这种状态的圣贤们编撰的。它们生动地描述了流经它们的宇宙知识。他们已经成为来自知识源头的纯粹光导体，完全超然，被赋予无限的理解力。`,source:"translate-leela/locales/zh/65-interiorspaceplan-zh.md"},{plan:66,title:"极乐计划 (ananda loka)",description:null,body:`意识被描述为真理、存在和极乐——Sachchidananda。阿难陀是最高的真理，存在的本质。在创作过程中，“我”逐渐被五层贝壳覆盖。
...
在Uranta-loka中，独立的“我”的感觉消失了。留在原质世间，玩家获得所有感官对象内在统一的知识。感官感知的世界合而为一，正如所有最终基于对这个世界的感知的感受和体验融合在一起一样。`,source:"translate-leela/locales/zh/66-blissplan-zh.md"},{plan:67,title:"宇宙利益计划 (Rudra-loka)",description:null,body:`Rudra 是湿婆神的名字之一。所有的创造都会经历三个阶段。显现伴随着新兴形式的维持，并不可避免地以解体或破坏而告终。这三个过程——创造、维护（保存）和毁灭——是由全能者的三种力量进行的，这三种力量不是由任何人创造的，而是创造一切。从他的意志中诞生了创造者（梵天）、保护者（毗湿奴）和毁灭者（湿婆）。这三种力量相互依存、相互关联。创造是按照至尊主的意志进行的，受造物通过他的意志得以保存并最终被毁灭。如果不破坏错误的自我认同——独立现实、个人自我的概念——真正的结合（瑜伽）是不可能的。因此，湿婆摧毁了虚假的自我，将个体意识与其宇宙源头联系起来。
...
Rudra-loka 是棋盘顶排的三个中心广场之一，负责所有创造的神圣力量位于此处，每个寻求解放的人都努力团结在一起。对正确知识的追求将玩家引向湿婆神座。在这里，他认识到了宇宙善，其本质是真理，形式是美。`,source:"translate-leela/locales/zh/67-planofcosmicgood-zh.md"},{plan:68,title:"宇宙意识 (Vaikuntha Loka)",description:null,body:`Vaikuntha 超越一切世俗，超越一切限制，是宇宙意识的世俗，是所有显现现实的生命力（普拉那）。这个世间还包含一种称为“mahat”的元素，它是所有其他元素的来源。在开始游戏之前，参与者接受这个存在层面的重要性和意义，这将永远是他的目标。无论什么欲望诱惑他偏离自己的道路，他的最高愿望始终是解脱。外琨塔 (Vaikuntha) 是毗湿奴 (Vishnu) 的住所，印度教的每一个追随者都希望通过结束毗湿奴目前的形态来到达那里。这就是宇宙意识，因为毗湿奴作为真理，是意识上升过程中的守护神和保护者。
...
比赛停止。现在发生什么取决于玩家。太空游戏的本质很简单——就是发现新的组合。玩家将带着怎样的新业力、怎样的同伴重新进入游戏，努力重新寻找真正的归宿？他可以继续和自己玩捉迷藏的游戏，也可以永远退出游戏。或者，他可能会返回地球，扮演重生菩萨的角色，帮助其他求道者实现他们的目标。选择权是他的。`,source:"translate-leela/locales/zh/68-cosmicconsciousness-zh.md"},{plan:69,title:"绝对计划 (Brahma-loka)",description:null,body:`Vaikuntha loka 的一侧是 Rudra loka，另一侧是 Brahma loka。它们一起构成了棋盘顶排中央的梵天、毗湿奴和湿婆三位一体。这个位面高于所有造物位面、七个主要位面以及所有其他位面，无论是否在游戏板上标记。 Mahat 也是这里的主要元素。那些坚定地扎根于真理的人生活在这里，不用担心随后会返回履行业力角色。慈悲行者也来到这里，他们住在梵天的住处，没有恐惧。

梵天是物质世界的创造者，是本体的活跃原则，是将意识转化为无数形式和反映的力量。他的居所是梵天界。到达这个地方的玩家就融入了这种绝对的力量，这种微妙的法则。梵天是物质的组织者，决定着所创造形式的发展规律。

即使梵天洛卡位于宇宙意识位面旁边，梵天也无法给予玩家解放。比赛必须继续下去。梵天决定了游戏的形式，但它的意义不仅仅在于形式。只有真理才能带领玩家走向解放。而现在三支枪就在前方等着他，而塔莫枪对应的蛇迟早会把玩家送回地球母亲身边。他下降到第六脉轮的水平，但现在他已经了解了在梵天世界中获得的游戏原理。这可以帮助他实现他在地球上的目标。精神奉献之路在距离他一掷骰子的地方等待着他。`,source:"translate-leela/locales/zh/69-planoftheabsolute-zh.md"},{plan:70,title:"Sattvaguna",description:null,body:`周六意味着真理。获得解脱后，一个人只能在宇宙意识中看到真理。但同样的真理，与业力骰子联系在一起，就受到三种属性（意识的三个主要方面）的作用（属性的意思是“品质、财产”）。属性和品质是玩家固有的，仍然与游戏相关。
...
在一种被称为“turiya”或“三摩地”的无意识意识状态中，玩家处于纯粹的萨特瓦之中。从gunas的影响中解放出来使一个人成为一个自觉的存在，gunatit（字面意思是“超越gunas”）。基纳作为动态力量，在创造过程中转变原始物质，并在每个创造周期开始时开始工作。他们彼此从未分离，共同行动，并通过彼此而改变。萨埵在创造过程中变成塔玛斯，创造声音、触觉、视觉图像、味觉和嗅觉的振动。 Rajas 是变革的力量。随着意识的进化，塔玛斯（tamas）以同样的方式变成萨埵（sattva）——通过拉贾（rajas）。萨特瓦本身并不活跃，如果没有王者的帮助，萨特瓦就无法改变。在地球上，萨埵在黎明时分以及接下来的三个小时内盛行。`,source:"translate-leela/locales/zh/70-sattvaguna-zh.md"},{plan:71,title:"拉乔贡",description:null,body:`拉贾古纳是意识中的活动或主动意识。已经达到第八行，但在实现宇宙意识的尝试中失败的玩家，会被业力、活动的力量所推动。这种活动是所有痛苦的根源，它以行动者的存在为先决条件，而行动者不可避免地会成为其野心和对活动成果的期望的受害者。实现预期目标的路上的任何障碍都会引起痛苦和磨难。拉霍古纳的主导地位不可避免地会导致痛苦和痛苦。
...
拉古纳的活动时间为日出后三小时至傍晚太阳落山。在这个时期，地球上的一切都变得活跃起来，一切都包含在旨在维持生命的活动中。拉古什将人们的注意力吸引到外部世界；如果它是向内的，rajoguna就成为一种内部对话。如果没有将塔玛斯转化为萨埵，就无法达到更高的意识状态。然而，通过在圣性工作中使用拉乔古纳（rajoguna），人们可以在活动期间保持圣性。`,source:"translate-leela/locales/zh/71-rajogun-zh.md"},{plan:72,title:"塔莫古纳",description:null,body:`日落之后直到黎明，塔莫古纳盛行，整个世界陷入沉睡。最初，像其他古纳一样，塔莫古纳处于初级原质中。创造开始后，玛哈特出现，其中萨特瓦古纳占主导地位。玛哈特（Mahat）诞生了智慧（buddhi），而自我（ahamkara）由此产生。 Sattvic ahamkara 产生心灵（manas）和rajasic - indriyas（感觉器官和活动器官），而 tamasic ahamkara 产生 tanmatras。 Tanmatra 的意思是纯粹的、未混合的东西。有五种：声音、触觉、视觉图像、味道和气味。它们对应于五大元素（mahabhutas）：阿卡莎（以太）、空气、火、水和土。它们结合起来形成一个单独的“我”，其中古纳斯的行为在所有四种意识状态中都得到体现。在物质世界中运作的形态与存在于原质中的纯粹形态不同。在这个级别，塔莫古纳成为游戏板上最大的蛇 - 这是塔马斯，位于与第七脉轮相对应的行末端的区域。在第八行，gunas 更接近它们的源头（prakriti） - 因此，它们更纯粹。

游戏板的最后一个方块也是太空游戏新周期的开始，为玩家提供形式和物质。这里有一条蛇会蜇玩家，将他们带回地面。

塔莫古纳是意识中的一种差异化能量。萨埵之光在她内心闪耀，但由于无知和缺乏奉献精神，它无法自行发展。为此，rajas是必要的，然后sattva才能显现出来，到达地球后，在业力的帮助下采取新的形式。塔莫古纳隐藏了真相，让绳子看起来像蛇，蛇看起来像绳子。黑暗是塔莫古纳的主要标志，其本质是被动性。进入这里的玩家立刻离开宇宙能层，返回地球寻找新的扬升之路。接下来发生的事情仅取决于玩家和真理者。`,source:"translate-leela/locales/zh/72-tamogun-zh.md"}];export{a as default};
