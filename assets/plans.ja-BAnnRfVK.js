const n=[{plan:1,title:"誕生(じゃんま)",description:null,body:`誕生はカルマゲームへの入り口です。カルマはサイコロの出目の数によって決定され、プレーヤーの個性は、そのロットに従ってマスからマスへと移動する何らかのシンボルによってフィールド上で表現されます。生まれる前、人はゲームから外れます。誕生すると、彼はカルマの法則の影響を受けるようになります。この世はカルマの国です。
...
ユニットはすべての創造の根源です。すべての奇数と同様に、それは太陽のファミリーに属します。私たちの惑星を誕生させたのは太陽であるため、このユニットは太陽と特別な関係を持っています。このユニットは、独立した人、独立した決定、独立した生活、新しい、珍しい、オリジナルなものの探求を象徴しています。`,source:"translate-leela/locales/ja/1-birth-ja.md"},{plan:2,title:"マヤ",description:null,body:`自分がプレイヤーになると、ゲームの盛り上がりに一体感が失われる。この意識の変化の中に、ゲームという行為の魅力のすべてが隠されています。一人が大勢になって、かくれんぼという宇宙的なゲームをします。自分のエゴを満たすために、プレイヤーはルールを受け入れることでゲームを開始し、ゲームが終了するまでこれらのルールに従います。
...
2 は二元性、つまり幻想の性質を持っています。この番号は、ユニットが繰り返されるときに取得されます。 2 は幻想です。なぜなら、その反対のものが両方とも 1 の中に存在するからです。これは、内なる世界と外なる世界、顕現されない世界と顕現された世界、シヴァとシャクティ、男性原理と女性原理、太陽と月、濃密な世界と微妙な世界、絶対とマーヤ、ヌーメノンと現象です。つまり、2 はマヤの数です。 2 は偶数であり、他のすべての偶数と同様に、月のファミリーの一部です。彼女は特に月と月のエネルギーと強く結びついています。`,source:"translate-leela/locales/ja/2-maya-ja.md"},{plan:3,title:"怒り (krodha)",description:null,body:`怒りの性質を理解するには、エゴの性質を理解することが不可欠です。エゴとは、自分自身を「私」であると認識するものです。人間は発達の過程において、一連の同一化を経ます。誕生後、子供は母親から離れていることに気づき、初めて自分が独立した存在であると感じ始めます。次に、他の家族との同一化が起こり、彼らの行動や思考形態を自分のものとして受け止めます。そして、子供は自分と同じ性別の仲間と自分自身を結びつけます。そして彼は異性の中に自分のアイデンティティを求めます。この旅は、エゴが最終的に自分自身を絶対者と認識し、宇宙の意識と融合するときに終わります。
...
この 3 つは創造性、表現力、安定性の特質を体現しています。奇数族の一員として、彼女はダイナミズムと積極性を表し、形の創造と維持を担当します。それは火の要素に関連付けられており、人間の中で怒りの形で現れます。一方で、同じ要素が勤勉さや忍耐力として現れることもあります。したがって、数字の3の特徴は強さと決意です。 3は木星の数です。木星は、勇気、勇気、強さ、力、勤勉、エネルギー、知識、知恵、精神性の象徴です。`,source:"translate-leela/locales/ja/3-anger-ja.md"},{plan:4,title:"貪欲(lobha)",description:null,body:`すべての生命に生じる分離感により、プレイヤーは満足を求め始めます。この世界で何らかの機能を実行するには、プレイヤーはまず自分の身体的ニーズが満たされていることを確認する必要があります。ゲームに参加するには、食事、休む場所、衣服が必要です。第 1 チャクラのレベルにあるプレイヤーの主な関心事は、物質的な生存です。
...
4 の記号は、4 つの次元と 4 つの基本点を表す正方形です。数字の4は地球の要素を象徴しています。偶数族の代表であるため、4人は完成度が高い傾向にあります。物質面での完璧を求める欲求は、極限まで追求されると貪欲に変わります。ヴェーダの数秘術では、数字の 4 は、ドラゴン ヘッドとしても知られる北の月のノードであるラーフによって支配されます。西洋の数秘術では、この数字は天王星によって支配されます。`,source:"translate-leela/locales/ja/4-avarice-ja.md"},{plan:5,title:"物理面 (ブーロカ)",description:null,body:`現われていない現実の領域が、名前と形の世界に変わります。名前と形の世界は、昇順に並べられた 7 つの異なるロカ、つまり存在のレベルの形で存在します。これらのロカは、個人の意識の進化における段階として機能します。人間は成長するにつれて、自分の性質に起こる変化に従って前進します。これらの面を通して、意識はその真の性質を理解することができます。
...
微細な要素の数は、エーテル、空気、火、水、土の 5 つです。人間にはカルマを生み出すための 5 つの活動器官があり、それらは手、足、口、生殖器、肛門です。また、音を知る耳、触覚を知る皮膚、形や色を知る目、味を知る舌、匂いを知る鼻という五つの感覚器官もあります。 5 はバランスの数です。1 つの辺に 2 が 2 つあります。数字の5を支配する惑星は水星です。マーキュリーは穏やかで、高尚な事柄について考えるのが好きで、科学者であり、エンターテイメントの愛好家でもあります。水星はビジネスの資質や身体的な快適さにも関連しています。`,source:"translate-leela/locales/ja/5-physicalplan-ja.md"},{plan:6,title:"妄想(モハ)",description:null,body:`モハという言葉はサンスクリット語で「執着」を意味します。この執着は、プレイヤーを現象の世界で何度も生まれ、生まれ変わらせる奴隷的な束縛の原因です。経典には、個人の意識をエネルギーの下向きの流れに導き、霊的な成長の障害となる4つのタイプの憑依があると述べられています。
...
数字の 6 は、2 つの奇数または 3 つの偶数 (トリプルが 2 つ、または 2 が 3 つ)、つまり 5 つの可能な要素の組み合わせで構成されます。したがって、完璧なバランスが保たれています。 6 は創意工夫、創造性、芸術に関連しています。彼女は月の数字の家族の代表であり、金星と関連付けられています。金星は惑星の中で最も明るく、明けの明星として肉眼で見ることができます。ヒンドゥー教の神話では、ヴィーナス (シュクラ) は悪魔の教師です。幻想の中に生き、官能的な快楽を愛し、欲望を満たすためにエネルギーを浪費し、怒りと貪欲の餌食となり、ダルマの法則に反して行動し、無宗教で、ひどく利己的な人々です。`,source:"translate-leela/locales/ja/6-delusion-ja.md"},{plan:7,title:"ヴァニティ（まだ）",description:null,body:`虚栄心とは自己欺瞞、偽りのプライド、空中に城を築くことです。サンスクリット語では、「マダ」という言葉は、虚栄心に加えて、「酩酊」も意味します。プレイヤーは自分の強さ、現実または想像上の美徳、功績に酔いしれます。自分自身についての妄想を抱くと、彼はマダの網に落ちてしまいます。ゲームに入った後、プレイヤーはマダ ヴァニティとさまざまな偽りのアイデンティティの影響を受けます。プライドと虚栄心は、私たちが劣悪な環境にいるときに摂取する最も危険な毒の 2 つです。妄想と貪欲の産物であるバッド・カンパニーは、プレイヤーを虚栄心に導く蛇です。このフィールドでは、プレイヤーは自分のゲームのネットワークに完全に巻き込まれていることに気づきます。彼が置かれている劣悪な環境は邪悪な欲望の現れです。
...
7 は伝統的に、ドラゴンの尾としても知られる月の南ノードであるケートゥと関連付けられています。現代のインドの数秘術では、数字の 7 は水の王ヴァルナによって支配され、西洋の数秘術では海王星によって支配されます。 7人は、成長していないときは誤ったプライドを持ち、空中に城を築き、常に将来のことを心配していることで知られる作家や芸術家の数です。彼らは人里離れた道を歩くことを好まず、宗教について非常に特殊な考えを持っています。彼らは独自の宗教を作り、娯楽に人生を費やす傾向があります。`,source:"translate-leela/locales/ja/7-vanity-ja.md"},{plan:8,title:"強欲",description:null,body:`虚栄心は、プレイヤーを誰もが羨ましくなり始めるという事実に導きます。彼は自分自身が別の現実であるという幻想に夢中になっているため、自分の欲望を満たすためのあらゆる手段が彼には正しいように思えます。結局のところ、うぬぼれたギャンブラーは、自分は他の人たちよりもはるかに優れているので、彼らが持っているものをすべて手に入れる権利があると考えています。したがって、このゲームでは、貪欲は嫉妬の蛇と関連付けられているためです。それは貪欲につながる虚栄心によって生み出された羨望です。貪欲の状態では、プレイヤーは他のプレイヤーに対して積極的な憎しみを経験します。彼は彼らにとって良すぎるし、彼らが持っているものもまた彼らにとって良すぎる。したがって、プレイヤーは、彼らのものは私のものであるべきだと主張します。彼は無愛想になり、周囲の人々の物質的な富を手に入れたいという情熱的な願望を抱きます。この感情は、物質的な面だけが目に見える貪欲とは異なります。貪欲とは、貪欲と妬みが組み合わさったものです。プレイヤーがますます貪欲になるにつれて、富への渇望は増大します。そして、第一チャクラの他のすべての問題も彼を苦しめ始めます。
...
1 日以上眠らないと、プレイヤーは惰性、眠気、退屈、無知から解放されます。一定時間完全な沈黙を維持すると、思考プロセスが浄化されます。断食は体を浄化します。苦難を乗り越えることはプレイヤーの人格を浄化し、経典の朗読や神の霊感を受けた詩を聞くことはプレイヤーの内面を浄化し、マントラを唱えることは神経を浄化し、集中と瞑想は体と心の両方を浄化します。性生活の禁欲も浄化の方法の一つとして機能します。これは、習慣的な振動レベルを変えるのは難しいですが、非常に効果的な方法です。`,source:"translate-leela/locales/ja/10-cleansing-ja.md"},{plan:11,title:"エンターテイメント (ガンダルヴァ)",description:null,body:`経典には、ガンダルヴァは主の音符であると書かれています。ガンダルヴァという言葉は「天国の音楽家」と訳されます。これは、通常の視覚では認識できない8種類の生き物のうちの1つですが、望めば目に見える形をとることもできます。彼らは微細な物質から創造され、アストラル界に住んでいます。これらの存在たちの生活は神聖な音楽と調和しており、進化の過程でこの次元に到達した神々や他の存在たちの娯楽に捧げられています。プラーナにはガンダルヴァとアプサラ（ニンフ）に関する物語がたくさんあります。当初、彼らは誕生と死のサイクルから自由ですが、彼らの行動がこの存在界の条件に反する場合、彼らは地面に落ち、人間の形で生まれます。しかし、どこにいても、人生は他人の娯楽に役立ちます。プレイヤーはクリア後にエンターテイメントエリアに入ります。このレベルは内なる喜び、リズムとハーモニーの感覚を反映しています。エンターテイメントは軽やかな気分をもたらし、リラックスしてその瞬間を楽しむことを促します。それらは日常生活の単調さを活気づけ、新しい視点と地平線を開きます。すべての芸術作品はこの状態の産物であり、ゲーム盤の 2 列目に属し、第 2 チャクラの振動のさまざまな側面を表しています。ただし、原則自体はあらゆるレベルに存在します。たとえば、Leela のゲームは、完璧を目指す人々のためのエンターテイメントとして機能します。

人生はエンターテイメント、つまり楽しむという原則に基づいています。しかし、そのような人生観は、主な問題である自己不信と物質的な幸福へのこだわりを伴う第1チャクラのレベルを克服した後にのみ達成されます。エンターテインメントはスピリットの本質です。この創造された宇宙はすべて、シャクティ、母なる原理、絶対者、神...私たちが至高のプレイヤーに選んだ名前が何であれ、それによって実行されるエネルギーの遊びです。もしこの原則が神のゲームの性質に含まれていなかったら、そのとき、一者は多数にはならないでしょう。ザ・ワンの娯楽として機能するゲームにますます深く入り込み、プレイヤーは最後に神と再会するためにそのルールを染み込ませます。`,source:"translate-leela/locales/ja/11-entertainment-ja.md"},{plan:12,title:"Envy (irasya)",description:null,body:`Envy はボード上の最初のヘビです。それはプレイヤーを刺し、貪欲の次元の第 1 レベルと第 1 チャクラの他のすべての特性に戻します。羨望の細胞に置かれると、プレイヤーは自信の欠如を経験し、自分の欲望を克服するために、第 1 チャクラに特徴的な戦略に頼ります。このヘビはプレイヤーを何度も刺してダウンさせ、ゲーム中に頭をすっきりさせるのに役立ちます。

人生ゲームでは、エネルギーは下から上に移動します。プレイヤーは、下で直面しなければならない問題から目を背けながら、低層界を抜け出して頂上に到達するよう努めます。

しかし、そのような立場は、ゲームの最も重要な原則の 1 つに反しています。プレイヤーは、カルマのダイスがどこに向かうにせよ、上下両方で自分の役割を調和して果たさなければならないからです。しかし、誰も落ち込んだくありません。プレイヤーの振動が不調和になると、プレイヤーはヘビの影響を受けて低層界に落ちます。彼の上下の動きはすべて、彼がサイコロを振った目によって決まります。人は嫉妬の影響を受けると、エネルギーが低下します。カルマ的状況の偶然の一致により、彼は第 2 チャクラ界に落ちましたが、本当にここに留まる資格はありません。実際、彼の性格に負の波動が残っているため、彼はこの次元に留まることができません。そのような瞬間、プレイヤーはバランスを崩さずに高い次元に留まることができる人を羨ましく思います。羨望とは、プレーヤーを第 1 チャクラのレベルまで低下させる否定的な反応であり、プレーヤーはそこで自分の否定的なカルマの新しい要素を認識し、解決する必要があります。`,source:"translate-leela/locales/ja/12-envy-ja.md"},{plan:13,title:"取るに足らないもの (アンタリクシャ)",description:null,body:`アンタリクシャは、物質界と天（スヴァルガ・ロカ）の間に位置する界です。ここで、プレイヤーは「停止」状態にあります。つまり、天にも地にもいない、実際には何もありません。
...
しかし、無意味な状態は決して永遠ではありません。プレイヤーがエネルギー リソースの補充を開始すると、サイコロを振る番が来るまでにプレイを続ける準備が整います。`,source:"translate-leela/locales/ja/13-nullity-ja.md"},{plan:14,title:"アストラルプレーン（ブヴァル・ロカ）",description:null,body:`ブヴァルロカは、物理的なものに続き、それに密接に関係しているが、より微細な物質で構成されている平面です。 bhu-loka (最初の行の 5 番目の四角形) の説明で、存在の状態や人格の発達の程度を反映する 7 つの基本的な面、またはロカがあることをすでに説明しました。ブヴァルロカのレベルおよび第 2 チャクラでは、水の要素が支配的です。人間の身体では、第 2 チャクラが背骨に沿って第 1 チャクラのすぐ上にあるのと同じように、アストラル面は、ボードの「脊柱」上の物理的なチャクラのすぐ上にあります。
...
アストラル界は、地球と天国の間に位置する精神的な空間の次元です。プレイヤーはすでに地上界を克服しており、彼の空想は彼に天国のアイデアを与えます。危険なのは、空想がプレイヤーを現実から奪い、エネルギーを消耗させ、満たされないままになる可能性があるという事実にあります。`,source:"translate-leela/locales/ja/14-astral-ja.md"},{plan:15,title:"ファンタジー計画（ナガロカ）",description:null,body:`ナーガ・ロカは冥界でなければなりません。地球面の上には 7 つの面があり、その下にも 7 つの面があります。地球の下にある飛行機は水中にあります。これらのそれぞれの世界の支配者は、別個のクラスの存在です。 7 つの下位世界の 1 つはパタパであり、その支配者は蛇 (ナーガ) です。神話では、これらは人間の顔とドラゴンのような尾を持つ半神の生き物です。ナーガは、偉大な知恵を獲得した隠者修行者の一派としても理解されています。彼らのすべてを見渡す視線からは何も隠されておらず、隠すこともできません。ナーガ・ロカはファンタジーの次元であるため、ファンタジーと呼ばれる現象の性質に従って、それは地球の上ではなく地球の下に位置し、水に浸されています。
...
ナーガという言葉はサンスクリット語から「蛇」と訳されています。したがって、空想の次元は蛇の次元でもあります。蛇はエネルギーの象徴です。ヨギが修行を通じて高めようとするクンダリーニは、しばしば「蛇の力」と呼ばれます。西洋の神話では、蛇は悪魔の可能な形態の 1 つです。ヘビは、第 2 チャクラのレベルにあるプレーヤーに固有の絶え間ない動き、柔軟性、形状変化の性質を体現しています。そして、ヘビが地下の穴に避難するのと同じように、第 2 チャクラに対応する振動を持つプレーヤーも同様です。`,source:"translate-leela/locales/ja/15-fantasyplan-ja.md"},{plan:16,title:"嫉妬(ドヴェーシャ)",description:null,body:`彼は、他人の行動が自分自身についての考えと矛盾している場合、他人を疑うようになります。恋愛関係では、彼は嫉妬し、不倫を恐れます。彼の疑念は増大し、すぐに彼のエネルギーは第 1 チャクラに戻り、そこで彼は貪欲の網に捕らえられます。自己不信によって育まれた嫉妬は、安心感の喪失という結果をもたらします。これが第 1 チャクラの主な特徴です。自信の欠如は自己嫌悪にもつながり、それが他者への嫌悪感として重荷に投影されます。

自信を取り戻すために、プレイヤーは第 1 チャクラの経験を経て、その原因に対処し、振動を高める必要があります。`,source:"translate-leela/locales/ja/16-jealousy-ja.md"},{plan:17,title:"Compassion (だや)",description:null,body:`慈悲はプレイヤーの中にある神聖な特質の一つであり、その力は非常に強いため、プレイヤーを第 2 チャクラから第 8 チャクラ、そして絶対者の次元へと引き上げます。同情は共感の能力を開き、自我はあまりにも激しい感情の波に押し流され、喜びの涙が目に溢れ、心は賞賛と宇宙の愛で高鳴ります。プレイヤーは一瞬の間、神と一体になります。
...
プレイヤーは自分の「私」に対してカルマ的責任を負い、それは顕在化されたものと顕在化されていないもの、肉体と本質に分けられます。したがって、身体に関するカルマと精神に関するカルマがあります。 1つ目は、この世界での行動に関するものです。しかし、意識には世界全体が含まれるため、意識に関係するカルマもまたこの世界全体をカバーします。`,source:"translate-leela/locales/ja/19-plankarma-ja.md"},{plan:20,title:"チャリティー（ダーナ）",description:null,body:`振動レベルの上昇につながるカルマ行為は美徳として知られています。振動の周波数を下げるものは悪徳のようなものです。慈善は、第 3 チャクラのレベルに存在する人間の美徳です。それはプレイヤーをこのレベルの問題を超えて引き上げ、ハートチャクラのレベルにあるバランスの面まで一歩引き上げます。
...
慈善活動は発達中の自我を満足させ、プレイヤーを第 3 チャクラの束縛から解放します。慈善活動は、カルマの次元を通過する上で最も重要なマイルストーンの 1 つです。これは、社会における人間の活動の最も崇高な方向性の 1 つを動機付ける力であり、思いやりと第 3 チャクラの特徴を組織化する傾向の組み合わせです。`,source:"translate-leela/locales/ja/20-charity-ja.md"},{plan:21,title:"償い（サマナパパ）",description:null,body:`物質的および官能的な衝動の影響範囲から立ち上がったプレイヤーは、これらの欲望を満たす過程で他人を傷つける可能性があることに気づきます。彼は満足を追求するあまり、結果を考えずに盲目的に行動しました。救いの領域に入ると、彼は自分が不正な道を歩み、不正な手段に頼って自分の中に好ましくない波動を生み出し、それが今や内なる平和の達成を妨げていることに気づきます。
...
どちらの場合も、悔い改めは前向きな結果を生み出し、エネルギーの上向きの流れを確立します。プレイヤーは、すべての物事や現象の本質であるダルマの法則に従うことで、自分の間違いを償います。償いはこの包括的な法則に同調しており、それはゲーム ボード上の次のセルによって表されます。`,source:"translate-leela/locales/ja/21-redemption-ja.md"},{plan:22,title:"ダルマの計画（ダルマロカ）",description:null,body:`ダルマとは真実のすべてですよね。それは進化し続ける普遍的な原理であり、時間と空間を超えて人間の存在を導く力です。ダルマは不変ですが、その現れ方は状況によって異なります。それは現実の深層に存在し、法の流れに従う人は常にこの世の現実と調和します。
...
したがって、ダルマは不変であり、形式を超えており、プレイヤーごとにさまざまな形式を取ります。寒い気候に住んでいる人にとって、ダルマは暖かい服を着ることでしょう。飢えた人のダルマは食べることです。ダルマを学ぶ人にとって、それは瞑想し、サーダナまたは精神的な鍛錬に従うことです。子供のダルマは、精神世界を心配せずに自由に遊ぶことです。大人のダルマとは、精神の世界における自己の願望と自己主張です。ダルマは、創造のすべての要素間の正しい関係を維持する真実です。ダルマは、建設中の人格の建造物を取り囲む足場です。建物が完成するまで、足場はその構造を支えます。しかし、建物がすでに自立できるようになると、足場が解体されて、まだ不安定な新しい建物が建てられます。`,source:"translate-leela/locales/ja/22-plandharmas-ja.md"},{plan:23,title:"天空の平面（スヴァルガ・ロカ）",description:null,body:`天の次元であるスヴァルガ・ロカは、創造の 7 つの次元の 3 番目です。これら 3 つの次元 - ブロカ、ブヴァル ロカ、スヴァルガ ロカ - はすべて、創造主ブラフマーの一日の終わりに破壊され、次の日の夜明けに再び生まれ変わります。ブヴァルロカのレベルでは、すべては物理的な形で存在し、ブヴァルロカは欲望の領域に属し、シュワルガロカでは思考が前面に出ます。この次元を支配する主な力は火の要素です。ここに存在するすべてのものは火のように輝き、輝き、光ります。それが、この次元に生息する生き物が光を放射する理由です。輝く天使や神々の描写は、あらゆる民族の神話に見られます。
...
感覚と行動の器官を征服した人にとって、物質界に存在するすべてのものは調和のとれた神聖な形で現れます。低次の欲望、暴力、執着、強欲、嫉妬、金銭への貪欲、怒り、官能性、無意味さは存在しません。その代わりに、浄化、慈悲、喜び、楽しみに満ちた永遠の命があります。`,source:"translate-leela/locales/ja/23-heavenlyplan-ja.md"},{plan:24,title:"バッドカンパニー (クサンロカ)",description:null,body:`第 3 チャクラの自己識別特性を求めて、プレイヤーは自分をサポートしてくれる他の人々のグループを探します。彼は、自分一人では自分の計画を達成するには弱すぎることを認識しており、同じような道を歩む他の人を探して、志を同じくする人々のグループを作りたいと考えています。
...
悪い会社では、個人的な問題の原因は周囲の人々や社会にあるという意見が一般的です。最も顕著な例は、目的を達成するためにあらゆる手段を講じるテロリストのグループです。高い目標を掲げて自分たちの行動を正当化しても、お互いに誤解を招くだけだ。彼らは、特定の人を殺せば自分の欲望が満たされると考えています。彼らは自分たちの目標がすべての人にとって唯一正しい目標であると盲目的に信じています。このダルマからの逸脱は重大な権力乱用であり、第 3 チャクラのレベルにおける主要な問題の 1 つです。悪い仲間との付き合いは没落につながるアダルマです。プレイヤーはダルマの原則に注意深く従うことによってのみ、この罠を回避することができます。`,source:"translate-leela/locales/ja/24-badcompany-ja.md"},{plan:25,title:"グッドカンパニー (スサンロカ)",description:null,body:`第 3 チャクラでダルマの道を歩み始めたプレイヤーは、すぐに自分の最高の機能を開発し、実現しようと努力する人々の社会の中にいることに気づきます。このような環境にいると、プレイヤーは自分の探索が真実であることを確認し、自分と同じ目標を目指して努力している人が他にもいるという認識によってエネルギーが高まるのを感じます。第 3 チャクラの主な要求、つまり自我の拡大が再び機能します。このポジティブなコミュニティはスサンと呼ばれます。
...
良い仲間とは、第 3 チャクラに固有の自己認識と自己肯定への欲求のポジティブな側面です。プレイヤーがゲームの第 4 レベル、つまり宇宙の知性とバランスの次元に到達するまでに、障害となるものはもうありません。`,source:"translate-leela/locales/ja/25-goodcompany-ja.md"},{plan:26,title:"悲しみ（ドゥッカ）",description:null,body:`悲しみは、何かを失ったことによって引き起こされる体の化学的変化を説明するために使用される用語です。このエネルギーの損失とそれに伴う過剰なエネルギーの圧力により、体内にうつ病の状態が生じます。悲しみと喜びは、感情の連続体の両極です。喜びは拡大、外向性、波動の上昇の状態ですが、悲しみは収縮、内向性、抑圧された波動の状態です。どちらの場合も、時間の感覚が消え、一瞬が永遠のように感じられます。
...
それでも彼に希望を与える道はある。これは無私の奉仕であり、ボード上の次の四角形で表されます。`,source:"translate-leela/locales/ja/26-sadness-ja.md"},{plan:27,title:"無私の奉仕（パラマルタ）",description:null,body:`慈善活動に時々行われる行為が含まれる場合、無私の奉仕は永続的な地位、在り方です。パラマルタは、自分自身を顧みず、外の世界と調和しながら、今この瞬間を意識しながら、やるべきことをやって生きています。
...
第 3 チャクラでは、同じ考えを持つ人々のグループと自分を同一視し、第 2 チャクラでは自分の感情を同一視し、第 1 チャクラでは自分の肉体的な生存を確保する能力を同一視する必要があります。第 3 チャクラでは、彼はカルマの法則、慈善の意味、ダルマの倫理的側面、良い環境と悪い環境にいることの結果、人生の救いと苦しみを理解します。しかし、ゲームにおける自分の役割を理解するには、スダルマの領域にある第 4 チャクラのレベルに到達する必要があります。そこから、厳格な自制と自分自身への取り組みのための苦行の次元に移ります。スダルマの道をたどると、彼はボードの 6 列目の第 6 チャクラに直接つながります。`,source:"translate-leela/locales/ja/28-truereligiosity-ja.md"},{plan:29,title:"宗教性の欠如 (アダルマ)",description:null,body:`スダルマ・セルに入ったプレイヤーは、ゲーム内での自分の役割を発見し、結果には注意を払わず、それに従って行動し始めます。彼は、内なる声に耳を傾ける限り、何も恐れることはないことを知っています。自然法則に従った信仰がスダルマです。宇宙の原則を無視した盲目的な信仰は、アダルマにつながります。本質的に、人の個人的なダルマに反するすべての行為はアダルマです。アダルマは人を迷わせ、最初のチャクラ、つまり盲目的な信仰の本質である妄想に戻します。
...
信仰は、信仰、献身、バクティという第 4 チャクラのまさに本質です。この信念は、プレイヤーが自分の本質 (スダルマ) と調和して行動する場合、彼を苦行の次元に引き上げます。しかし、もし彼が正しい道から外れると、同じ信念が彼を再び間違いに陥らせます。これがアダルマです。信仰のみに基づいた行動は、人を真の宗教性から遠ざけてしまいます。存在の法則の理解に根ざしていない信仰は盲目です。そして、そのような盲信は、この次元でのエネルギー損失の最も一般的な原因です。存在の法則と調和した信仰はスダルマです。信仰だけがアダルマです。`,source:"translate-leela/locales/ja/29-lackofreligiosity-ja.md"},{plan:30,title:"良い傾向 (ウタマガティ)",description:null,body:`ウッタマは善を意味し、ガティは動きを意味します。大宇宙の法則と調和して行動すれば、良い傾向が自然にその選手に現れます。下の 3 つの平面で振動している限り、これらの傾向は発生しません。彼らの成長は、ある程度の内部バランスが達成される必要があるため、ここ第 4 チャクラでのみ始まります。
...
良い傾向を実践することは、プレイヤーが自分の人生を安定させ、エネルギーを散逸させる低位の中枢の影響から解放され、ポジティブな方向にリズミカルに発展できるようにするのに役立ちます。`,source:"translate-leela/locales/ja/30-goodtrends-ja.md"},{plan:31,title:"聖性の計画 (ヤクシャロカ)",description:null,body:`神聖な次元に入ったプレイヤーは、宇宙原理の理解を通じて神の恩寵を体験します。神聖さは善良な傾向の直接の結果です。これは、第 4 チャクラに関連する神の存在との一体感であり、すべての創造物における神の恵みの現れを見る能力です。この一体性は単なる知的理解を超え、日常生活の現実の一部になります。
...
プレイヤーがヤクシャロカに到達すると、神の存在の性質の問題に注意が向けられます。彼は神聖なものと日常生活とのつながりを見つけようとしています。彼は、第 4 チャクラに到達して初めて可能となる本当の経験を求めています。以前は、それは単なる抽象的な概念でした。今や、すべての創造物における神とその存在への関心、現実と向き合いたいという願望がプレイヤーの本質となります。`,source:"translate-leela/locales/ja/31-planofholiness-ja.md"},{plan:32,title:"バランスプラン (マハール・ロカ)",description:null,body:`マハルロカは、存在の 7 つのレベルの 4 番目のロカです。このロカは創造主ブラフマーの夜の始まりとともに破壊されると信じられています。最初の 3 つのロカは、ジーヴァ (個人の意識) が生きるアリーナとして機能し、一連の新しく生まれ変わる中で発展します。この第 4 のロカでも、第 3 のロカと同様に火の要素が支配的ですが、ここでは住民の体が輝き、輝きを放つスヴァルガ ロカほど美しくはありません。
...
毎日のヒンズー教の礼拝（サンディヤ）では、礼拝者は 7 つの主要なロカを列挙したマントラを唱えます。これらの各次元の名前を発音するとき、彼はそれに関連する体の部分に触れます。彼は、湿らせた右手の指先を肛門と性器の間、クンダリーニの座に当てて「オーム ブー」と発声します。それから彼は「オーム ブヴァ」と言い、第二の精神的中枢がある性器の根元に触れます。おへそを触りながら「オーム・スワ」と言いました。彼は心臓に触れながら「オム・マハ」、「オム・ジャナ」を喉の付け根まで、「オム・タパ」を第三の目、眉間のポイント、鼻梁のすぐ上に触れながら歌います。そして最後に、オーム サティヤム、頭のてっぺんに触れます。`,source:"translate-leela/locales/ja/32-balanceplan-ja.md"},{plan:33,title:"香りの計画（ガンダロカ）",description:null,body:`ガンダは「匂い」を意味し、嗅覚は地球の要素と物理的次元に関連付けられています。しかし、プレイヤーが第 4 レベルに到達すると、感覚的認識の性質が変化し、強力な感情を伴う神の象徴的な表現になります。修法に従い、信者は花や香の形で香りを神に捧げます。したがって、第 4 チャクラには、香りの平面、またはガンダ ロカが含まれています。
...
理解を深めてもらうために、スピリチュアルな実践に携わる人々は、自分たちの自然な匂いを認識するために、人工的なボディフレグランスの使用をやめることをお勧めします。体からの悪臭が消え、排泄物も汗も息も悪臭を放たなくなったとき、これは人のエネルギーが第 3 チャクラを克服し、香りの次元であるガンダ ロカに入ったことを意味します。ここには神の香りだけがあります。プレイヤーは自分のシステムから悪臭を完全に取り除きます。`,source:"translate-leela/locales/ja/33-aramat-ja.md"},{plan:34,title:"味の計画（ラサロカ）",description:null,body:`下部チャクラでは味覚は主に感覚的認識の一形態でしたが、第4チャクラでは美的感覚としての味覚に洗練されます。この次元に入った人は、アイデアと意味の世界に入り込みます。これにより、彼は感情的な経験の本質について直接的な経験的な知識を得ることができます。

ラサは愛、喜び、恵み、娯楽、味、感情、美しさ、情熱、精神です。それは詩的なインスピレーションであり、詩の本質です。種族は最も純粋な形の水であり、すべての創造物を結び付ける力です。

第 3 チャクラまでは、言葉のあらゆる意味での味覚はほぼ完全に、より低いレベルの活動に向けられています。第一チャクラでは、味覚はお金を稼ぎたいという欲求に完全に従属します。多くの体力を与える食べ物（特に肉）と、購入した既製の食べ物がプレイヤーの食事の基礎となります。大量の塩と香辛料が使われています。第 2 チャクラでは、エネルギーは官能性に向けられます。ここでプレイヤーは、卵、魚、高麗人参などの効能を高める食品に興味を持っています。第 3 チャクラでは、彼は味覚そのものを求めて、あらゆる種類の高級食品を消費します。心のレベルでは、味覚が浄化されます。プレイヤーは自分が摂取する食べ物の本質を理解するために、塩とお菓子を残します。プレイヤーが味覚の領域に入ると、あらゆる意味での味覚が洗練されます。食べ物、音楽、コミュニケーションにおける彼の好みは、自分のレベルに関係なく、誰にとっても心地よいものです。彼は誰もが認める、味の愛好家、目利きになります。したがって、彼はそのような状態に到達したいファンを魅了します。`,source:"translate-leela/locales/ja/34-tasteplan-ja.md"},{plan:35,title:"煉獄(ナラカロカ)",description:null,body:`プレイヤーが心のレベルに達するまでは、スダルマ、つまり真の宗教性についての理解が不足しています。そしてスダルマがなければ、行動の自由はあり得ません。しかし、プレイヤーが行動の自由を獲得するとすぐに、その結果に対して責任を負うことになります。ナラカ ロカは、プレイヤーが自分の「アカウント」に責任を負う場所です。
...
ナラカ ロカの主は、ダルマラジャとしても知られる死の主ヤマです。暴力はプレイヤーを煉獄、つまり最も苦痛な状況に導きます。すべての行動はそれに応じた結果をもたらします。これはカルマの法則であり、プレイヤーが肉体的に存在し続ける限り、その影響は避けられません。悪いカルマはプレイヤーをナラカロカ、つまりこのカルマに対応する場所に導きます。これは罰ではなく、浄化です。ナラカの主であるダルマラジャは、そこに行くプレイヤーの苦しみに個人的な関心はありません。むしろ、彼の仕事は否定的なものを修正し、将来の精神的な発展に道を開くことです。ナラカはハートチャクラそのものでもあります。感情への執着がナラカ、執着の感情がナラカです。ナラカはネガティブな波動です。ネガティブな感情を放射する人は、自分の能力に応じて、自分の家、家族、地域、都市、国、または世界にナラカを生み出します。第4レベルに固有の理解を持たずにナラカロカに入ると、プレイヤーは状況を失敗とみなし、そこにある否定的なカルマの結果がわかりません。そうすれば、ナラカ・ロカは行動の不完全さの表れに過ぎず、それを正さなければならないことが明らかになります。第4チャクラには評価のない気づきがあります。`,source:"translate-leela/locales/ja/35-purgatory-ja.md"},{plan:36,title:"心の明晰さ (スヴァッチャ)",description:null,body:`心の明晰さは、プレイヤーが第 4 レベルを出て人間が人間になる第 5 レベルに入るときに満たされる光です。サンスクリット語で「スヴァッチャ」という言葉は「純粋、透明、透明」を意味します。この透明度は、プレイヤーがナラカ ロカで経験する浄化プロセスの結果です。
...
スヴァッチャのフィールドに入ると、プレイヤーは純粋で透明になります。彼は疑惑に悩まされ、そのせいで真の宗教の道から外れるか、煉獄に行き着いたのです。しかし、この経験により彼はスダルマを理解しました。彼は良い傾向を身につけ、自分の人生を神聖なものにしました。彼は香りと味の次元を訪れ、今では第 5 チャクラへと向かうエネルギーの上向きの流れに加わる準備ができています。`,source:"translate-leela/locales/ja/36-clarityofmind-ja.md"},{plan:37,title:"Jnana（ジナナ）",description:null,body:`真実の知識と、それを日常生活で実践するための正しい手段の理解は、ジニャーナの 2 つの重要な特徴です。ジュニャーナは、チャクラを越えて 8 列目にある至福の次元にプレイヤーを引き上げる力です。ゲーム内での自分の役割と、その役割を果たすための行動の性質を理解しているプレイヤーは、至福の中で生きることができます。プレイヤーは精神的に明晰な体験をすることによってのみ、自分の知恵を実現することができます。彼が第 5 チャクラまで上昇することを可能にするエネルギーの変容は、すべての評価と判断が停止された場合にのみ起こります。
...
ジニャーナ フィールドは、当然のことながら、第 5 チャクラのレベルに位置しています。なぜなら、そこには、世界のあらゆる宗教の教えの本質である何十億もの白紙のページの源があるからです。第 5 チャクラでは、プレーヤーの主な関心は他者とのコミュニケーションになります。プレーヤーは、自分が達成したゲームの本質の理解を他の人に伝えようと努めますが、同時にそれが実現不可能であることも認識しています。`,source:"translate-leela/locales/ja/37-jnana-ja.md"},{plan:38,title:"プラナ ロカ",description:null,body:`プラーナは生命力です。サンスクリット語では、それは生命の同義語であり、私たちが呼吸するたびに受け取る生命の息吹の名前です。プラーナは、体内の 5 つの主要な微細エネルギーの 1 つの名前でもあります。この狭い意味では、プラーナは口腔内に存在し、食物を胃に運ぶエネルギーを指します。プラーナは鼻孔から肺、心臓近くの領域に存在し、生命を破壊から守っています。
...
ヨガにおいて、プラーナは最も重要な概念です。プラナヤマを練習することによって、ヨギはプラーナの流れを骨盤神経叢まで導き、そこで下半身にあるエネルギーであるアパナと混ざります。プラーナとアパナが背骨の中央通路であるスシュムナを通って頭のてっぺんまで一緒に流れるとき、ヨーガ行者はすべてのヨーガ実践の目標であるサマーディを体験します。プラーナを酸素と混同しないでください。酸素は粗大な肉体にエネルギーを供給します。一方、プラーナは肉体の存在を維持します。プラーナは生命そのものです。プラーナを理解するには、生命と意識を別々に考える必要があります。生命は意識が現れるメカニズムであり、プラーナはその原動力です。生命が消滅しても意識は残ります。これは、文書化された数多くの輪廻転生の事例によって示されています。`,source:"translate-leela/locales/ja/38-pranaloka-ja.md"},{plan:39,title:"アパナ ロカ",description:null,body:`プラーナは肺を通じて外部からエネルギーを吸収し、食物エネルギーを胃に運ぶ働きをする力ですが、アパナはその逆の働きをします。アパナは文字通り「下向き」を意味し、このエネルギーは体からのエネルギーの放出を担当します。それは体の下半身に位置し、子宮からの子供の出口に貢献します。それが下方向へのエネルギーの放出の原因となります。アパナは、排尿、排便、射精を司るエネルギーです。
...
ヨガで規定されているバンダ ロックを実践すると、アパナが上向きになります。おへそ付近に到達すると、消化の火が高まります。次に、アパナは第 3 チャクラで火と混ざり、第 4 チャクラに浸透し、そこでプラーナと混ざります。プラーナは本質的に熱いものです。この混合により熱がさらに増加し、両方のエネルギーが上昇して真空が生じます。経典には、プラーナとアパーナの混合から生じるこの激しい熱の助けにより、クンダリーニが目覚め、穴に這う蛇のように中央の通路に入ると言われています。このプラーナとアパナの混合は、ヨギの体の若返りにつながります。彼は16歳のときと同じように、生命力に満ち、丈夫で精力的なものになります。したがって、この分野では、プレーヤーは人生におけるアパナの重要性を認識し、適切な食事やその他の実践を通じてエネルギーを調和のとれた状態に保つ方法を学びます。`,source:"translate-leela/locales/ja/39-apanaloka-ja.md"},{plan:40,title:"ヴィアナ・ロカ",description:null,body:"ヴィアナはプラニックエネルギーを肺で受け取り、それを体のすべてのシステムに分配します。この生命エネルギーは、血液の流れ、腺の分泌、体の上下の動き、まぶたの開閉に関与しています。ヴィアナは毛細血管系を通じて血液中の酸素を運びます。酸素とプラーナエネルギーは組織に吸収され、老廃物は血液中に排出されます。この血液はヴィアナを介して静脈系に戻り、ヴィアナはこの汚染された廃血を心臓と肺に戻します。ヴィアナは発汗も担当します。汗は特定の場所から放出されるのではなく、体のあらゆる毛穴から放出されます。肺の領域にある生命エネルギーであるプラーナはこの働きをすることができません。同じことが体の下半身で排出する働きをするアパナにも当てはまります。汗はそれ自体で動くことができず、体中に存在し、血液循環、発汗、咳のプロセスを通じて化学バランスを維持する上で重要な役割を果たすヴィアナによって動かされます。",source:"translate-leela/locales/ja/40-vyanaloka-ja.md"},{plan:41,title:"人間飛行機 (ジャナロカ)",description:null,body:`第 5 レベルの第 5 次元であるジャナロカは、シッダ (高度な発達に達し、下位次元の人々にとって「超自然的」な行動を実行できる力を持つ存在) と聖人たちの住居です。 、常にハリ神（ヴィシュヌ神の名前の一つ）の瞑想に浸っています。
...
この次元で、プレイヤーは人間であることの本当の意味を学びます。多くの場合、これは無私の奉仕の領域からつながる矢印によって、第 3 チャクラのレベルから直接達成されます。`,source:"translate-leela/locales/ja/41-humanplan-ja.md"},{plan:42,title:"アグニ（アグニロカ）の計画",description:null,body:`アグニは、同じ神聖な本質の終わりのない周期的な再生の最も純粋な現れです。火は精神であり、魂であり、同時に体でもあります。人間を含む多様な存在や現象で満たされたこの世界全体は、神の火から生まれました。火を象徴する神の像には 3 つの顔があり、3 つのタイプの火を表しています。パヴァカ - 電気の火、パヴァマナ - 摩擦から生じる火、シュチ - リグ ヴェーダでヴァイシュヴァナーラと呼ばれる神の火 - 生きた磁気の火です。それは宇宙全体に浸透しています。ヴァイシュヴァナラという言葉は、ハイヤーセルフを指すこともよくあります。
...
これらの女性への欲望で神の火が燃え上がり、すぐに性交の準備が整いました。アグニが種を注ぎ出すと、それは土となった。したがって、私たちの惑星はアグニの創造物であり、彼が巣の真ん中で燃やした火から生まれました。現代科学は、地球はかつて火の玉（アグニ）であったと主張しています。水は地球の表面を冷やし、生命の出現の可能性を生み出しました。今でも地球の中心部には火が残っており、地球の深部から赤熱した溶岩を噴出させる火山噴火として現れています。この内なる火が消えると、この地球上の生命は消滅します。`,source:"translate-leela/locales/ja/42-planagni-ja.md"},{plan:43,title:"人間の誕生（マヌシャジャンマ）",description:null,body:`アグニの次元を通過すると、プレイヤーは形をとる（誕生）準備が整います。マヌシャジャンマはこのイベントの完了を示します。第 2 チャクラで妊娠し、第 3 チャクラで栄養を与えて育ち、第 4 チャクラで人間の感情が満たされ、プレイヤーは今、生まれる準備が整いました。
...
人間は合理的な存在です。この理性の賜物は、彼のすべての考え、言葉、行動を真実と関連付けることに役立ちます。真実の法に反する人生を送っている人には、人間と呼ばれる完全な権利はありません。それは、人間の身体の中に生き、人間として生まれようと努力している別の存在です。`,source:"translate-leela/locales/ja/43-birthofman-ja.md"},{plan:44,title:"無知 (アヴィディヤ)",description:null,body:`無知の領域に入ったプレイヤーは、存在の幻想的な性質を忘れ、特定の感情状態や感覚的認識に執着するようになります。無知の蛇に刺されたプレイヤーのエネルギーは、第 1 チャクラと官能の次元のレベルまで下がります。マーヤ（幻想）の性質を理解できなくなると、知性が曇り、特定の状態と同一視するようになります。
...
正しい知識の分野は、ゲームの 5 列目である第 5 チャクラの通過を完了します。この段階で、プレイヤーは宇宙との一体性を完全に認識し、究極の現実と融合し、宇宙の善の次元であるルドラ（シヴァ）の次元に上昇します。`,source:"translate-leela/locales/ja/45-correctknowledge-ja.md"},{plan:46,title:"差別（ヴィヴェカ）",description:null,body:`現象界に存在するものはすべて現実ではありません。知覚の対象は時間とともに変化し、発展し、成長し、崩壊します。しかし、これらの感覚的認識の対象は、現実の完全な幻想を作り出します。人は客観的な世界を非常に重視し、感覚認識の対象と同一化したいという欲求を育みます。ヴィヴェカ、つまり差別こそが、物質への執着への欲望に陥ることから彼を救う力なのです。これはプレイヤーの内なる知恵の声であり、プレイヤーが微細なものと粗大なものを区別し、あらゆる現象の中に意味を見出すことを可能にします。
...
プレイヤーが第 6 チャクラに到達するまでは、「差別」という言葉は彼らにとってほとんど意味を持ちません。しかし、第 6 チャクラを通過するかどうかは、カルマのサイコロの落ちとヴィヴェカの内なる声の促しによって決まります。`,source:"translate-leela/locales/ja/46-distinction-ja.md"},{plan:47,title:"中立計画 (サラスワティ)",description:null,body:`人間の体の精神的エネルギーは、脊椎の中枢神経管、つまりサラスヴァティを通って流れます。ヨガの哲学によれば、このエネルギーの流れは最初のチャクラから始まり、プレイヤーが次の列に進むにつれて徐々に高くなっていきます。ヨガの最終目標は、このエネルギーを頭のてっぺんにある第7チャクラまで高めることです。
...
ヤムナ (ジャムナ) は、インド北部のウッタル プラデーシュ州のプラヤグ ラージ (現在のアラハバード) で合流する 3 つの神聖な川の 1 つです。クリシュナはヤムナ川のほとりで生まれました。`,source:"translate-leela/locales/ja/48-sunnyplan-ja.md"},{plan:49,title:"月の計画 (ガンガー)",description:null,body:`この次元に入ったプレイヤーは、女性の磁気エネルギーの源にいることに気づきます。ここでは、脊椎の左側にあるイダナディ神経の影響下にあります。アイダは、その女性的な（栄養を与える）性質に従って、身体の栄養源と考えられています。女性は常に魅力的で魅力的ですが、男性は感銘を受け、力に満ちています。
...
ヨガの一般的なルールは次のとおりです。日中は左の鼻孔が優位になり、夜は右の鼻孔が優位になる必要があります。月の呼吸は、日中は太陽エネルギーの優位性を補うために必要であり、夜間は太陽エネルギーが月の優位性のバランスをとるために必要です。`,source:"translate-leela/locales/ja/49-lunarplan-ja.md"},{plan:50,title:"苦行の計画 (タパロカ)",description:null,body:`第 5 チャクラの場合と同様に、プレーヤーにとって知識が最も重要でした。ここでは、苦行の次元において、プレーヤーのすべての願望は、苦行と苦行のハードワークを行うことに向けられています。タパスという言葉は「苦行」、「苦行」、「燃焼」を意味します。これが自己否定瞑想の実践です。
...
そして、プレイヤーが地球のことをよく知れば知るほど、その表面で生命を維持しているとらえどころのないバランスをより深く理解できるようになります。第一チャクラの人にとって、彼女は結果を考えずに好きなものを何でも取り出せる単なる胸にすぎません。第 6 チャクラの人は、自分の愛する地球が大きな危険に直面し、取り返しのつかないダメージを受ける可能性があるのを見たときに、そのような態度が致命的であることに気づきます。`,source:"translate-leela/locales/ja/51-earth-ja.md"},{plan:52,title:"暴力の計画 (ヒムサロカ)",description:null,body:`第 6 チャクラに到達したプレイヤーは、万物の統一を実現します。人間の体は一時的な形態としてのみ機能します。すべてのプレイヤーの本質は、名前や形を超えて存在します。プレイヤーは、死が人生のシナリオの単なる変化であることを知っています。ここで、プレイヤーが自分の行動が最終的には他のプレイヤーに実害を及ぼすものではないことを十分に承知しながら、暴力に訴え始める危険性が生じます。
...
流動性と精神的な愛の欠如により、プレーヤーは煉獄でさらなる苦行を必要とするようになり、そこでゲームを続けて精神的な愛の道を模索するためには心から悔い改めなければなりません。`,source:"translate-leela/locales/ja/52-planviolence-ja.md"},{plan:53,title:"流体のプラン（ジャラ・ロカ）",description:null,body:`水は本来冷たいので、熱を吸収して冷たさをもたらします。第6チャクラの苦行、苦行の熱がプレイヤーを残酷にする。暴力の燃えるエネルギーを消し、それを精神的な愛の均一な暖かさに変えるために、彼は液体界の澄んだ水を通過する必要があります。
...
水にはそれ自体の形はなく、水が入っている器の形をとります。これは第 6 チャクラプレイヤーの主な特性でもあり、エゴに反するものになる能力です。本当のゲームは、プレイヤーがプレイヤーとしてのアイデンティティを失ったときに始まります。第 6 チャクラが出現し、無形になる能力が現れるまで、プレイヤーはお金、セックス、権力、カルマ、そして知識の探求の囚人でした。ゲームは第 6 チャクラから始まります。このとき、すでに知識が得られ、プレイヤーをフォームと同一視する幻想が消えています。`,source:"translate-leela/locales/ja/53-fluidplan-ja.md"},{plan:54,title:"精神的な献身 (バクティ ロカ) のプラン",description:null,body:`バクティ、つまり精神的な献身は、「愛は神であり、神は愛である」という言葉に基づいています。バクタの信者は自分の神を愛しています。神は恋人であり、信者は恋人です。バクタは別離に苦しみ、恋人に会いたい、少なくとも一目見たいと切望しています。他に彼を惹きつけるものは何もなく、彼の注意を引くものは何もなく、他のものはすべてその意味を失います。食事、睡眠、セックス、執着、情事、それ以外は何も関係ありません。彼は別離の感覚に完全に浸り、恍惚の中で、少なくとも一度は主から見つめられることだけを祈ります。バクタが神の恵みによって祝福されると、彼は切り離せない一体性を経験し、非二元の意識状態が確立されます。彼と彼の神は今や一つであり、神の経験自体が神からの恵みと祝福の証拠です。
...
ジュニャーナはプレイヤーを賢者にしますが、バクティはプレイヤーを父の慈悲深い保護の下、母の膝の上で聖なる子供に変えます。賢者が主に会うまでの道のりは長い。バクタは常に神に囲まれており、人生経験のあらゆる部分に無数の姿と名前で存在します。`,source:"translate-leela/locales/ja/54-planofspiritualityanddevotion-ja.md"},{plan:55,title:"利己主義 (アハンカーラ)",description:null,body:`アハムは「私」または「私は7歳」を意味します。カラは「形」です。 「私」が形になると、それはアハンカーラになります。プレイヤーの人格の活動の中心が彼の「私」になると、彼のアハンカーラはマーヤによって「私」と「私のもの」という概念に閉じ込められます。現実の最高の側面であるアハンカーラが、全体と一体化する必要性を忘れ、別個の部分になると、それは、利己主義に変わってしまいます。
...
オームによって人は直接の人生経験では決して存在しなかった知識にアクセスできるようになるというヴェーダの主張は、サスカチュワン大学で行われた研究で確認されました。 200 人の学生のグループが、実験参加者の誰も答えを知らなかった質問を解決するためにオームを歌いました。 1時間歌った後、生徒の一人は、オームの助けで開かれた宇宙の知識の宝庫から答えを受け取りました。`,source:"translate-leela/locales/ja/56-planinitialvibrations-ja.md"},{plan:57,title:"飛行機（ヴァーユロカ）",description:null,body:`Vayu loka (文字通り「飛行機」) は、プレイボードの 7 列目、現実の平面であるサティヤ ロカの領域にあります。このヴァーユは、物質界や地上界に見られる風や空気ではありません。これが空気という物理的要素の本質です。
...
第 6 チャクラでは液体の平面に遭遇しましたが、液体はまだ形を持っています。一方、気体には明確な形状がありません。液体には重さがありますが、気体には重さはありません。プレイヤーはもはや何にも重荷を負うことはなく、真の行動の自由を獲得します。彼は重力の影響を受けず、形を持たない存在になります。`,source:"translate-leela/locales/ja/57-plangas-ja.md"},{plan:58,title:"Plan of Radiance (テジャ・ロカ)",description:null,body:`テジャとは「光、輝き」を意味します。ウパニシャッドは 4 つの意識状態、つまり「私」について語っています。それらを列挙してみましょう:
...
どの矢印も輝きの平面につながっておらず、下にある平面から直接到達することはできません。プレイヤーは、精神的な献身を実践して最終的な解放を達成しない限り、ゆっくりと徐々にそれに向かって進まなければなりません。`,source:"translate-leela/locales/ja/58-radianceplan-ja.md"},{plan:59,title:"Plan of Reality (Satya Loka)",description:null,body:`サティア ロカは、プレイング ボードの脊柱に位置する 7 つの主要なロカの最後の面です。サティヤ ロカの主な要素はアカシャ タットヴァです。ここでプレイヤーはシャブダ・ブラフマンの世界に到達し、輪廻転生から解放されようとしています。彼は最も高い次元に到達し、その先には宇宙意識の座であるヴァイクンタが横たわっています。サティヤ ロカは創造主ブラフマーの夜の間も滅びません。シャブダとはオームという言葉であり、ブラフマンそのもの（絶対現実、宇宙意識）です。シャブダ・ブラフマンは原初の振動の次元、つまりオームカーラです。この次元を通過した後、プレイヤーは現実に根を張ることができます。
...
スブッディのポジティブな振動は、ダルマの道をたどることによって達成されます。ダルマのセル上で、矢印が始まり、この面につながります。プレイヤーのダルマ フローと組み合わせたポジティブ インテリジェンスは、プレイヤーの解放の探求を支援するゲーム内で最も強力なツールの 2 つです。`,source:"translate-leela/locales/ja/60-positiveintelligence-ja.md"},{plan:61,title:"ネガティブ・インテリジェンス (ドゥルブッディ)",description:null,body:`プレイヤーがダルマの法則に従わず、あらゆる経験における存在の宇宙的性質と神の存在を疑うと、ネガティブな知性の蛇に噛まれて、取るに足らない次元に落とされてしまいます。
...
ただし、無意味は一時的な状態です。宇宙意識だけが絶対的かつ永続的です。プレイヤーが再び第 7 チャクラに到達した場合、無への強制追放により、ポジティブな知性を維持し、このヘビの顎を避けるという内なる欲求が生まれるかもしれません。`,source:"translate-leela/locales/ja/61-negativeintelligence-ja.md"},{plan:62,title:"Happiness (スカ)",description:null,body:`身体と心の相性のバランスが幸せです。 Sukha (幸福) とは、プレイヤーが洞察力 (ヴィヴェーカ) またはオームを唱え、サマーディを達成し、前向きな知性を維持することによって達成される状態です。
...
真の幸福は、バランスを保ちながらゴールに近づくプレイヤーにあります。ゲームは全体として重要です。彼の安定した知性により、流れの形、法の流れを明確に見ることができます。彼は人生が彼に提示するすべてを受け入れます。彼が拒否するものは何もありません。たとえ第 8 面に到達し、再び地球に戻らなければならなかったとしても、彼は達成できる目標を知ってまだ幸せです。`,source:"translate-leela/locales/ja/62-happiness-ja.md"},{plan:63,title:"タマス",description:null,body:`タマスという言葉はサンスクリット語で「暗闇」「暗闇」を意味します。暗闇とは光の欠如です。光は知識であり、闇は無知です。無知は低次の心です。サンスクリット語では、この言葉には「蛇」という2番目の意味もあります。タマスは暗闇の蛇であり、ゲーム内で最も長い蛇であり、プレイヤーを現実面の輝きから容赦なく幻想へと引き込みます。
...
それが、タマスのフィールドがゲームの第 7 レベルにある理由です。ここでタマスは蛇になります。下位次元では、プレイヤーにはタマスが必要でした。しかし、ここでは、非行為の一形態である瞑想の次元において、タマスはエネルギーの流れを逆転させ、プレイヤーを再び幻想に陥らせる蛇です。タマスはタモグナの属性であり、小宇宙におけるその現れです。同じ力がゲームの 8 行目でプラクリティの属性として議論される場合、それはタモグナと呼ばれます。`,source:"translate-leela/locales/ja/63-tamas-ja.md"},{plan:64,title:"フェノメナル プレーン (プラクリティ ロカ)",description:null,body:`『バガヴァッド・ギーター』の中で、シュリ・クリシュナはプラクリティの二面性について語っています。それは明白であり、神聖なものでもあります。顕在化したプラクリティは物質世界であり、地、水、火、空気、エーテル（アカシュ）、そして心（マナス）、知性（ブッディ）、エゴ（アハンカーラ）の要素で構成されています。これらはプラクリティの 8 つの重大な症状です。神聖なプラクリティはマーヤ・シャクティです。プラクリティの 8 つの現れについて説明した後、クリシュナはアルジュナにこう言います。「私のもう 1 つのプラクリティ、最高の、この世界を支える存在するすべての生命も知ってください。」
...
現実の次元を横断すると、プレイヤーはプラクリティ ロカに到達し、3 つのグナと 5 つの要素が最も純粋で本質的な形で彼の前に現れます。`,source:"translate-leela/locales/ja/64-phenomenalplan-ja.md"},{plan:65,title:"内部空間の計画（ウランタ・ロカ）",description:null,body:`7 列目を離れてプラクリティの存在に気づき、プレイヤーは現象世界のすべての現象の源である大いなる意識に入り込み始めます。プレイヤーはそれと融合し、その瞬間、すべての二元性は消えます。プレイヤーは、自分の「私」の中にある無限の空間、計り知れない次元の純粋な体験を得ることができます。

ウルは人の「私」の感情を意味し、アリは「終わり」を意味します。ウランタロカは、自分の分離した「私」の感覚が終わり、あらゆる分裂が消え、プレイヤーが内なる生活の言葉では言い表せない深みに飛び込む場所です。彼は一息の間に、創造物全体の誕生、発展、そしてその後の破壊を目撃します。彼はすべての境界と区別の幻想的な性質を見ています。プラクリティの性質とすべての創造物の根底にある統一性を認識した彼は、今この統一性と融合しています。ここには感情も感覚もありません。 「私」は、自分自身が不変の観察者であることを十分に認識しています。善も悪も悪徳も美徳もありません。プレイヤーは光を透過する純粋なクリスタルのようになります。プラーナとサムヒターでは、この状態を経験した聖なる予言者によってまとめられたウランタ・ロカの記述を見つけることができます。彼らはそこに流れる宇宙の知識を生き生きと描写しています。彼らは知識の源からの純粋な光の導体となり、完全に切り離され、限界のない理解を与えられました。`,source:"translate-leela/locales/ja/65-interiorspaceplan-ja.md"},{plan:66,title:"至福のプラン (アーナンダ ロカ)",description:null,body:`意識は真実、存在、そして至福、サッチダーナンダとして説明されます。アーナンダは最高の真実、存在の本質です。創造の過程で、「私」は徐々に5つの殻で覆われます。
...
ウランタロカでは、独立した「私」の感覚が消えます。プラクリティ ロカに留まり、プレイヤーはすべての感覚対象の内部統一についての知識を獲得します。感覚的に認識される世界は、最終的にこの世界の認識に基づいたすべての感情と経験が融合するのと同じように、1 つになります。`,source:"translate-leela/locales/ja/66-blissplan-ja.md"},{plan:67,title:"宇宙利益計画 (ルドラロカ)",description:null,body:`ルドラはシヴァ神の名前の一つです。すべての創造は 3 つの段階を経ます。発現には出現形態の維持が伴い、必然的に崩壊または破壊で終わります。これらの 3 つのプロセス、つまり創造、維持（保存）、破壊は、全能の 3 つの力によって実行され、誰によっても創造されたのではなく、すべてを創造しています。彼の意志により、創造者（ブラフマー）、維持者（ヴィシュヌ）、そして破壊者（シヴァ）が生まれました。これら 3 つの力は相互に依存し、相互に関連しています。創造は主の意志によって行われ、主の意志によって被造物は保存され、最終的には破壊されます。偽りの自己同一視、つまり別個の現実、個人のエゴの概念を破壊しなければ、真の結合（ヨーガ）は不可能です。このようにして、シヴァは偽りの自我を破壊し、個人の意識をその宇宙の源と結び付けます。
...
ルドラ ロカは、プレイング ボードの最上列にある 3 つの中央広場の 1 つであり、すべての創造に責任を負う神の力が位置しており、解放を求めるすべての人が団結しようと努めています。正しい知識の追求がプレイヤーをシヴァ神の座へと導く。ここで彼は、宇宙の善、その本質は真実であり、その形は美であるという認識に達します。`,source:"translate-leela/locales/ja/67-planofcosmicgood-ja.md"},{plan:68,title:"宇宙意識 (ヴァイクンタ ロカ)",description:null,body:`あらゆるロカを超え、あらゆる限界を超えて立ち上がっているのは、宇宙意識のロカ、すべての現れた現実の生命力（プラーナ）であるヴァイクンタです。このロカは、他のすべての要素の源であるマハトと呼ばれる要素からも構成されています。ゲームを開始する前に、参加者はこの存在の次元の重要性と意味を受け入れ、それが常に彼の目標になります。いかなる欲望が彼を自分の道から外そうと誘惑しても、彼の最大の欲望は常にモクシャ、つまり解放です。ヴァイクンタはヴィシュヌ神の住居であり、ヒンズー教の信者なら誰でも、現在の姿での存在を終わらせることによって到達したいと願う場所です。ここに宇宙の意識があります。なぜならヴィシュヌ神は真実であり、上昇中の意識の守護者であり保護者だからです。
...
ゲームが停止します。これから何が起こるかはプレイヤー次第です。宇宙ゲームの性質は単純で、新しい組み合わせを発見することです。プレイヤーは、どのような新しいカルマを持って、どのような仲間とともにゲームに再参加し、真の故郷となる州を再び見つけることができるでしょうか?彼は自分自身とこのかくれんぼのゲームを続けることもできますし、永遠にゲームから遠ざかることもできます。あるいは、二度生まれた菩薩の役割を引き受けることで、他の探求者が目標を達成できるよう助けるために地球に戻るかもしれません。選択は彼のものです。`,source:"translate-leela/locales/ja/68-cosmicconsciousness-ja.md"},{plan:69,title:"絶対者の計画 (ブラフマーロカ)",description:null,body:`ヴァイクンタ ロカの一方の側にはルドラ ロカがあり、もう一方の側にはブラフマ ロカがあります。彼らは一緒に、プレイボードの最上段の中央にブラフマー、ヴィシュヌ、シヴァの三尊を形成します。この次元は、ゲームボード上でマークされているかどうかに関係なく、創造のすべての次元、7 つの主要な次元および他のすべての次元を上回ります。マハトはここでも主要な要素として機能します。真実にしっかりと根ざしている人々は、その後カルマ的役割を果たすことへの回帰を恐れることなくここに住んでいます。慈悲の実践者もここに来て、恐れることなくブラフマーの住まいに留まります。
...
ブラフマ ロカは宇宙意識界の隣にありますが、ブラフマはプレイヤーに解放を与えることはできません。試合は続けなければなりません。ブラフマーはゲームの形式を決定しますが、それには形式だけではありません。プレイヤーを解放に導くことができるのは真実だけです。そして今、その先には3つのグナが彼を待っており、タモガンに対応するヘビは遅かれ早かれプレイヤーを母なる地球に戻します。彼は第 6 チャクラのレベルまで下がりましたが、今ではブラフマロカで獲得したゲームの原理を理解して武装しています。そしてこれは、彼が地球上で彼の目標を達成するのに役立ちます。精神的な献身への道は、サイコロの目 1 つ目の距離で彼を待っています。`,source:"translate-leela/locales/ja/69-planoftheabsolute-ja.md"},{plan:70,title:"サットヴァグナ",description:null,body:`Satは真実を意味します。解放を達成した人は、宇宙意識の中でのみ真実を見ます。しかし、同じ真実が、カルマのサイコロと結びついて、意識の 3 つの主要な側面である 3 つのグナの作用の対象になります (グナは「品質、財産」を意味します)。特性と品質は、ゲームにまだ関連付けられているプレーヤーに固有のものです。
...
トゥーリヤまたはサマーディとして知られる無意識の意識状態では、プレイヤーは純粋なサットヴァの中にいます。グナの影響から解放されると、人は悟った存在、グナティット（文字通りには「グナを超えた」という意味）になります。グナは、創造の過程で主要な物質を変化させる動的な力として機能し、創造の各サイクルの開始時にその働きを開始します。それらは決して互いに分離されることはなく、一緒に行動し、お互いを通して変化します。創造の過程でサットヴァはタマスとなり、音、感触、視覚的イメージ、味、匂いの振動を生み出します。ラジャスは変革する力です。意識の進化とともに、タマスも同様にラジャスを通じてサットヴァになります。サットヴァ自体は活動的ではなく、ラジャスの助けなしに変化することはできません。地球上では、夜明けとその後の 3 時間はサットヴァが支配します。`,source:"translate-leela/locales/ja/70-sattvaguna-ja.md"},{plan:71,title:"ラジョグン",description:null,body:`ラジョグナは意識の活動、または能動的な意識です。 8 列目に到達したが、宇宙意識を実現する試みに失敗したプレイヤーは、カルマの力、つまり活動によって前に進められます。この活動はすべての苦しみの原因であり、活動の成果に対する野心と期待の犠牲となる行為者の存在を前提としています。望ましい目標に向かう途中に障害があると、痛みや苦しみが生じます。ラジョグナの優位性は必然的に痛みと苦痛をもたらします。
...
ラジョグナは、日の出の3時間後から太陽が沈み始める夕方まで続きます。この期間中、地球上のすべてのものは活動し、すべてのものは生命を維持することを目的とした活動に含まれます。ラジョグシュは人の注意を外の世界に向けます。それが内向きであれば、ラジョグナは内なる対話になります。タマスからサットヴァへの変化がなければ、より高次の意識状態は達成できません。しかし、サトヴィックな働きにおいてラジョグナを用いることで、人は活動中にサットヴァに留まり続けることができます。`,source:"translate-leela/locales/ja/71-rajogun-ja.md"},{plan:72,title:"タモグナ",description:null,body:`日没後から朝の薄明までタモグナが蔓延し、全世界が眠りに落ちます。最初は、他のグナと同様に、タモグナは主要なプラクリティにあります。創造の始まりの後、マハートが生じ、サットヴァグナが優勢になります。マハトは知性（ブッディ）を生み出し、そこから自我（アハンカーラ）が生じます。サトヴィックなアハンカーラはマインド（マナス）とラジャシックなインドリヤ（感覚器官と活動器官）を生成し、タマシックなアハンカーラはタンマトラを生成します。タンマトラとは、純粋で混ざり合っていないものを意味します。それは、音、触覚、視覚イメージ、味、匂いの5つです。それらは、アカシャ (エーテル)、空気、火、水、土の 5 つの偉大な要素 (マハブータ) に対応します。それらが組み合わさって、グナの作用が 4 つの意識状態すべてに現れる、個々の「私」を形成します。物質世界で機能するグナは、プラクリティの中に存在する純粋なグナとは異なります。このレベルでは、タモグナは盤上で最大のヘビになります。これはタマスであり、第 7 チャクラに対応する列の最後にあるフィールドです。 8 行目では、グナはその源 (プラクリティ) に近いため、より純粋になります。

ゲーム ボードの最後のマスは宇宙ゲームの新しいサイクルの始まりでもあり、プレイヤーに形と物質を提供します。ここにはプレイヤーを刺して地面に戻すヘビがいます。

タモグナは意識における分化したエネルギーです。サットヴァの光は彼女の中で輝いていますが、無知と献身の欠如により、それは自ら発展することができません。このためにはラジャスが必要であり、そうすればサットヴァが現れ、地球に到達してカルマの助けを借りて新しい形を取ることができます。タモグナは、縄が蛇に見えるように、蛇が縄に見えるように真実を隠します。暗闇はタモグナの主な兆候であり、その性質は受動性です。ここに入ったプレイヤーは直ちにコズミックパワーレベルを抜け出し、新たなアセンションの道を模索するために地球に戻ります。次に何が起こるかは、プレイヤーと真実なる者にのみ依存します。`,source:"translate-leela/locales/ja/72-tamogun-ja.md"}];export{n as default};
